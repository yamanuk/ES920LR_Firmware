...
typedef struct {
  ...
  bool EnUser;                          
  bool EnMode;                          
  LDD_TClockConfiguration LastClock;    
  LDD_TUserData *UserDataPtr;           
} PitTimeStamp_TDeviceData;

typedef PitTimeStamp_TDeviceData *PitTimeStamp_TDeviceDataPtr;  
...
LDD_TDeviceData* PitTimeStamp_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv->SavedISRSettings_TUInterrupt.isrData = _int_get_isr_data(0x26u);
  DeviceDataPrv->SavedISRSettings_TUInterrupt.isrFunction = _int_install_isr(0x26u, PitTimeStamp_Interrupt, DeviceDataPrv);
   
  ((((SIM_MemMapPtr)0x40047000u))->SCGC6) |= 0x800000u;
   
  ((((PIT_MemMapPtr)0x40037000u))->MCR) = 0x00U;                      
   
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. TCTRL) = 0x00U;                   
   
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. TFLG) = 0x1u;        
   
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. LDVAL) = (((uint32_t)(((uint32_t)(0x14))<<0))&0xFFFFFFFFu);     
   
  ((((NVIC_MemMapPtr)0xE000E100u))->IP[5]) = (uint32_t)((((((NVIC_MemMapPtr)0xE000E100u))->IP[5]) & (uint32_t)~(uint32_t)(
               (((uint32_t)(((uint32_t)(0x7F))<<16))&0xFF0000u)
              )) | (uint32_t)(
               (((uint32_t)(((uint32_t)(0x80))<<16))&0xFF0000u)
              ));
   
  ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (((uint32_t)(((uint32_t)(0x00400000))<<0))&0xFFFFFFFFu);
   
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. TCTRL) = 0x2u;      
  DeviceDataPrv->EnUser = ((boolean)0);        
  DeviceDataPrv->LastClock = (LDD_TClockConfiguration)0xFFU;  
  PitTimeStamp_SetClockConfiguration(DeviceDataPrv, Cpu_GetClockConfiguration());  
   
  (PE_LDD_DeviceDataList[0x07U] = DeviceDataPrv);
...
void PitTimeStamp_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)DeviceDataPrv;
  ( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. TCTRL) = (uint32_t)(( (uint32_t)(( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. TCTRL)) & ( (uint32_t)(~(uint32_t)0x1u)))) | ( (uint32_t)(0u))) );
   
   
   
  (void)_int_install_isr(0x26u, ((PitTimeStamp_TDeviceDataPtr)DeviceDataPrv)->SavedISRSettings_TUInterrupt.isrFunction, ((PitTimeStamp_TDeviceDataPtr)DeviceDataPrv)->SavedISRSettings_TUInterrupt.isrData);
  ( ((((PIT_MemMapPtr)0x40037000u))->MCR) = (uint32_t)(( (uint32_t)(((((PIT_MemMapPtr)0x40037000u))->MCR) & (uint32_t)(~(uint32_t)0x2u))) | ( (uint32_t)(0x2u))) );
   
  (PE_LDD_DeviceDataList[0x07U] = ((pointer)0));
...
LDD_TimerUnit_Tfloat PitTimeStamp_GetInputFrequencyReal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  switch (Cpu_GetClockConfiguration()) {
    case 0x00U:
      return 20971395.017196544F;
    case 0x01U:
      return 23999808.00153599F;
    default:
      break;
  }
  return 20971395.017196544F;
...
LDD_TError PitTimeStamp_SetPeriodTicks(LDD_TDeviceData *DeviceDataPtr, PitTimeStamp_TValueType Ticks)
{
  ...
  ( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. LDVAL) = (uint32_t)((uint32_t)(Ticks-1)) );
  return 0x00U;                        
}
...
LDD_TError PitTimeStamp_GetPeriodTicks(LDD_TDeviceData *DeviceDataPtr, PitTimeStamp_TValueType *TicksPtr)
{
  ...
  *TicksPtr = (PitTimeStamp_TValueType)(( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. LDVAL) ) + 1U);
  return 0x00U;                        
}
...
LDD_TError PitTimeStamp_ResetCounter(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  _int_disable();
  if ((( (uint32_t)(((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. TCTRL) & 0x1u) )) != 0U) {
    ( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. TCTRL) = (uint32_t)(( (uint32_t)(( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. TCTRL)) & ( (uint32_t)(~(uint32_t)0x1u)))) | ( (uint32_t)(0u))) );
    ( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. TCTRL) = (uint32_t)(( (uint32_t)(( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. TCTRL)) & ( (uint32_t)(~(uint32_t)0x1u)))) | ( (uint32_t)(1u))) );
  }
...
void PitTimeStamp_SetClockConfiguration(LDD_TDeviceData *DeviceDataPtr, LDD_TClockConfiguration ClockConfiguration)
{
  ...
  switch (ClockConfiguration) {
    case 0x00U:
      ...
      NewConst = 20971395.017196544F;  
      break;
    case 0x01U:
      DeviceDataPrv->EnMode = ((boolean)1);     
      NewConst = 23999808.00153599F;  
      break;
    default:
  ...
  if (DeviceDataPrv->EnMode) {
    switch (DeviceDataPrv->LastClock) {  
      case 0x00U:
        OldConst = 20971395.017196544F;  
        break;
      case 0x01U:
        OldConst = 23999808.00153599F;  
        break;
      default:
        OldConst = NewConst;            
        break;
    ...
    if (OldConst != NewConst) {         
      OldRegVal = (uint32_t)(( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. LDVAL) ));
      NewRegVal = (uint32_t)(((((LDD_TimerUnit_Tfloat)(OldRegVal) + 1U)) * (NewConst / OldConst)) - 1U);  
      if (NewRegVal > 0xFFFFFFFFUL) {   
        ( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. LDVAL) = (uint32_t)(0xFFFFFFFFUL) );  
      }
      else {
        ( ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. LDVAL) = (uint32_t)(NewRegVal) );
      }
    }
    DeviceDataPrv->LastClock = ClockConfiguration;  
  }
  HWEnDi(DeviceDataPtr);                
}
...
void PitTimeStamp_Interrupt(LDD_RTOS_TISRParameter _isrParameter)
{
  ...
  ( (((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. TFLG) = 0x1u), (void)((((PIT_MemMapPtr)0x40037000u))->CHANNEL[(0U)]. LDVAL) );  
  PitTimeStamp_OnCounterRestart(DeviceDataPrv->UserDataPtr);  
}
