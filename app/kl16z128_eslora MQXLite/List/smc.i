...
void enter_stop(unsigned char partial_stop_opt)
{
    ...
    ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) &= ~0x7u;
    ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) |=  (((uint8_t)(((uint8_t)(0))<<0))&0x7u);
    ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL) &= ~0xC0u;
    ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL) |= partial_stop_opt;
     
    dummyread = ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL);
...
int enter_vlpr(void)
{
    ...
    if ((((((SMC_MemMapPtr)0x4007E000u))->PMSTAT) & 0x7Fu)== 4)
    {
        return_value = 0x14;
    }
    ...
    ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) &= ~0x60u;
    ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL)  |= (((uint8_t)(((uint8_t)(0x2))<<5))&0x60u);
    ...
    for (i = 0 ; i < 10000 ; i++)
    {
        ...
        if ((((((PMC_MemMapPtr)0x4007D000u))->REGSC) & 0x4u) ==0x04)
        {
    ...
    if ((((((SMC_MemMapPtr)0x4007E000u))->PMSTAT) & 0x7Fu) == 4)
    {
        return_value = ((((SMC_MemMapPtr)0x4007E000u))->PMSTAT);
    }
...
void exit_vlpr(void)
{
    ...
    if  ((((((SMC_MemMapPtr)0x4007E000u))->PMSTAT) & 0x7Fu)== 4)
    {
        ...
        for (i=0;i<0xff;i++)
        {
            if ((((((SMC_MemMapPtr)0x4007E000u))->PMSTAT) & 0x7Fu)== 1)
                if ((((((PMC_MemMapPtr)0x4007D000u))->REGSC) & 0x4u) == 1)
    	            break;
        }
    }  
...
void enter_vlps(void)
{
    ...
    ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) &= ~0x7u;
    ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) |=  (((uint8_t)(((uint8_t)(0x2))<<0))&0x7u);
...
void enter_lls(void)
{
    ...
    ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) &= ~0x7u;
    ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) |=  (((uint8_t)(((uint8_t)(0x3))<<0))&0x7u);
...
void enter_vlls3(void)
{
    ...
    ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) &= ~0x7u;
    ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) |=  (((uint8_t)(((uint8_t)(0x4))<<0))&0x7u);
     
    ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL) =  (((uint8_t)(((uint8_t)(3))<<0))&0x7u);
     
    dummyread = ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL);
    dummyread = dummyread + 1;
...
void enter_vlls2(void)
{
    ...
    ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL) =  (((uint8_t)(((uint8_t)(2))<<0))&0x7u);
...
void enter_vlls1(void)
{
    ...
    ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL) =  (((uint8_t)(((uint8_t)(1))<<0))&0x7u);
...
void enter_vlls0(unsigned char PORPO_value )
{
    ...
    ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL) &= ~0x7u;
    ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL) &= ~0x20u;
    ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL) |=  (PORPO_value <<5)
                 | (((uint8_t)(((uint8_t)(0))<<0))&0x7u);
...
void enter_vlls0_nopor(void)
{
    ...
    ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL) &= ~0x7u;
    ((((SMC_MemMapPtr)0x4007E000u))->STOPCTRL) =  (((uint8_t)(((uint8_t)(0))<<0))&0x7u) | 0x20u;
