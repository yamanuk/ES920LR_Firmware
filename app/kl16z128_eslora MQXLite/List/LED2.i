...
typedef LED2_TDeviceData *LED2_TDeviceDataPtr ;  

 
static LED2_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
...
LDD_TDeviceData* LED2_Init(LDD_TUserData *UserDataPtr)
{
  ...
  LED2_TDeviceDataPtr DeviceDataPrv;
  ...
  ((((GPIO_MemMapPtr)0x400FF100u))->PDDR) |= (((uint32_t)(((uint32_t)(0x20000))<<0))&0xFFFFFFFFu);
   
   
  ((((GPIO_MemMapPtr)0x400FF100u))->PDOR) |= (((uint32_t)(((uint32_t)(0x20000))<<0))&0xFFFFFFFFu);
   
   
  ((((PORT_MemMapPtr)0x4004D000u))->PCR[17]) = (uint32_t)((((((PORT_MemMapPtr)0x4004D000u))->PCR[17]) & (uint32_t)~(uint32_t)(
                 0x1000000u |
                 (((uint32_t)(((uint32_t)(0x06))<<8))&0x700u)
                )) | (uint32_t)(
                 (((uint32_t)(((uint32_t)(0x01))<<8))&0x700u)
                ));
   
  (PE_LDD_DeviceDataList[0x0AU] = DeviceDataPrv);
...
void LED2_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  ((((GPIO_MemMapPtr)0x400FF100u))->PDDR) &= (uint32_t)~(uint32_t)((((uint32_t)(((uint32_t)(0x20000))<<0))&0xFFFFFFFFu));
   
  (PE_LDD_DeviceDataList[0x0AU] = ((pointer)0));
...
{
  (void)DeviceDataPtr;                  
  ( ((((FGPIO_MemMapPtr)0xF80FF100u))->PCOR) = (uint32_t)(0x20000U) );
}
...
{
  (void)DeviceDataPtr;                  
  ( ((((FGPIO_MemMapPtr)0xF80FF100u))->PSOR) = (uint32_t)(0x20000U) );
}
...
{
  (void)DeviceDataPtr;                  
  ( ((((FGPIO_MemMapPtr)0xF80FF100u))->PTOR) = (uint32_t)(0x20000U) );
}
