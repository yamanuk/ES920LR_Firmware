...
const TCpuClockConfiguration PE_CpuClockConfigurations[0x02U] = {
...
void LDD_SetClockConfiguration(LDD_TClockConfiguration ClockConfiguration)
{
  ...
  if (PE_LDD_DeviceDataList[0x00U] != ((pointer)0)) {
    SystemTimer1_SetClockConfiguration(PE_LDD_DeviceDataList[0x00U], ClockConfiguration);
  }
   
  if (PE_LDD_DeviceDataList[0x01U] != ((pointer)0)) {
    StackTimer_SetClockConfiguration(PE_LDD_DeviceDataList[0x01U], ClockConfiguration);
  }
   
  if (PE_LDD_DeviceDataList[0x02U] != ((pointer)0)) {
    UARTA_SetClockConfiguration(PE_LDD_DeviceDataList[0x02U], ClockConfiguration);
  }
   
  if (PE_LDD_DeviceDataList[0x07U] != ((pointer)0)) {
    PitTimeStamp_SetClockConfiguration(PE_LDD_DeviceDataList[0x07U], ClockConfiguration);
  }
   
  if (PE_LDD_DeviceDataList[0x08U] != ((pointer)0)) {
    RealTimeClock_SetClockConfiguration(PE_LDD_DeviceDataList[0x08U], ClockConfiguration);
  }
