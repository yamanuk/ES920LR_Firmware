...
{  
    ...
    ((QUEUE_STRUCT_PTR)(&period_ptr->TIMERS))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&period_ptr->TIMERS))->NEXT); ((QUEUE_STRUCT_PTR)(&period_ptr->TIMERS))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&period_ptr->TIMERS))->NEXT); ((QUEUE_STRUCT_PTR)(&period_ptr->TIMERS))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&period_ptr->TIMERS))->MAX = (uint_16)0;
    period_ptr->TIMER_PTR = (pointer) &period_ptr->TIMERS;

    _int_disable();
    if (kernel_data->LWTIMERS.NEXT == ((pointer)0))
    {
         
        ((QUEUE_STRUCT_PTR)(&kernel_data->LWTIMERS))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->LWTIMERS))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->LWTIMERS))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->LWTIMERS))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->LWTIMERS))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&kernel_data->LWTIMERS))->MAX = (uint_16)0;
        kernel_data->LWTIMER_ISR = _lwtimer_isr_internal;
    }  
    period_ptr->VALID = (_mqx_uint)(0x6C777469);
    { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWTIMERS)))->PREV)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&period_ptr->LINK))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWTIMERS)))->PREV)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&period_ptr->LINK))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&period_ptr->LINK))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWTIMERS)))->PREV)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&period_ptr->LINK))); }; ++((QUEUE_STRUCT_PTR)((&kernel_data->LWTIMERS)))->SIZE;;
    _int_enable();
...
{  
    ...
    if (period_ptr->VALID != (_mqx_uint)(0x6C777469))
    {
        ;
        return (((0x0000)|0x40));
    }  
    ...
    i = ((QUEUE_STRUCT_PTR)(&period_ptr->TIMERS))->SIZE + 1;
    while (--i)
    {
    ...
    timer_ptr->VALID = (_mqx_uint)(0x6C777469);
    { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(qe_ptr)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&timer_ptr->LINK)))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(qe_ptr)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&timer_ptr->LINK)); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&timer_ptr->LINK)))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(qe_ptr)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&timer_ptr->LINK)); }; ++((QUEUE_STRUCT_PTR)(&period_ptr->TIMERS))->SIZE;;
    _int_enable();
...
{  
    ...
    if (timer_ptr->VALID != (_mqx_uint)(0x6C777469))
    {
        ;
        return ((0x0000)|0x40);
    }  
    ...
    { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(timer_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(timer_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&period_ptr->TIMERS))->SIZE;;
    _int_enable();
...
{  
    ...
    _int_disable();
    period_ptr->VALID = 0;
    { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(period_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(period_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&kernel_data->LWTIMERS))->SIZE;;
    _int_enable();
...
(
    pointer * period_error_ptr,
    pointer * timer_error_ptr
)
{  
    KERNEL_DATA_STRUCT_PTR    kernel_data;
    LWTIMER_STRUCT_PTR        timer_ptr;
    ...
    *period_error_ptr = ((pointer)0);
    *timer_error_ptr = ((pointer)0);
