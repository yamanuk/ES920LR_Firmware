...
{  
    ...
    _int_disable();
    if (td_ptr->STATE != (0x0A | (0x001)))
    {
        td_ptr->STATE = (0x0A | (0x001));
        td_ptr->INFO = (_mqx_uint) vector_number;
        _task_set_error_td_internal(td_ptr, ((0x0000)|0x41));
...
{  
    ...
    kernel_data = _mqx_kernel_data;
    if ( kernel_data->INTERRUPT_TABLE_PTR == ((pointer)0) )
    {
        _task_set_error(((0x0000)|0x18));
        return(((pointer)0));
    }  
    if ((vector < kernel_data->FIRST_USER_ISR_VECTOR) ||
        (vector > kernel_data->LAST_USER_ISR_VECTOR))
    {
        _task_set_error(((0x0000)|0x14));
        return(((pointer)0));
    } 
...
{  
    KERNEL_DATA_STRUCT_PTR kernel_data;
    INT_EXCEPTION_FPTR     old_handler = ((pointer)0);
