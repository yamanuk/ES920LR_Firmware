...
{  
   ...
   old = (_mqx_max_type)(((VCORTEX_SCS_STRUCT_PTR)(0xe0000000ul))->SCB . VTOR);;
   ((VCORTEX_SCS_STRUCT_PTR)(0xe0000000ul))->SCB . VTOR = ((uint_32)(addr));;
...
{
    return (_mqx_max_type)(((VCORTEX_SCS_STRUCT_PTR)(0xe0000000ul))->SCB . VTOR);;
}
