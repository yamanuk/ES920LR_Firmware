...
inline void BME_AND_W (volatile uint32_t *addr, register uint32_t wdata)
{
	*(volatile uint32_t*)((uint32_t)addr | (1<<26)) = wdata;
}

inline void BME_AND_H (volatile uint16_t *addr, register uint16_t wdata)
{
	*(volatile uint16_t*)((uint32_t)addr | (1<<26)) = wdata;
}

inline void BME_AND_B (volatile uint8_t *addr, register uint8_t wdata)
{
	*(volatile uint8_t*)((uint32_t)addr | (1<<26)) = wdata;
}

inline void BME_OR_W (volatile uint32_t *addr, register uint32_t wdata)
{
	*(volatile uint32_t*)((uint32_t)addr | (1<<27)) = wdata;
}

inline void BME_OR_H (volatile uint16_t *addr, register uint16_t wdata)
{
	*(volatile uint16_t*)((uint32_t)addr | (1<<27)) = wdata;
}

inline void BME_OR_B (volatile uint8_t *addr, register uint8_t wdata)
{
	*(volatile uint8_t*)((uint32_t)addr | (1<<27)) = wdata;
}

inline void BME_XOR_W (volatile uint32_t *addr, register uint32_t wdata)
{
	*(volatile uint32_t*)((uint32_t)addr | (3<<26)) = wdata;
}

inline void BME_XOR_H (volatile uint16_t *addr, register uint16_t wdata)
{
	*(volatile uint16_t*)((uint32_t)addr | (3<<26)) = wdata;
}

inline void BME_XOR_B (volatile uint8_t *addr, register uint8_t wdata)
{
	*(volatile uint8_t*)((uint32_t)addr | (3<<26)) = wdata;
}

 
inline void BME_BFI_W (volatile uint32_t *addr, register uint32_t wdata, uint8_t bit, uint8_t width)
{
	*(volatile uint32_t*)((uint32_t)addr | (1<<28) | (bit<<23) | ((width-1)<<19)) = wdata;
}

inline void BME_BFI_H (volatile uint16_t *addr, register uint16_t wdata, uint8_t bit, uint8_t width)
{
	*(volatile uint16_t*)((uint32_t)addr | (1<<28) | (bit<<23) | ((width-1)<<19)) = wdata;
}

inline void BME_BFI_B (volatile uint8_t *addr, register uint8_t wdata, uint8_t bit, uint8_t width)
{
	*(volatile uint8_t*)((uint32_t)addr | (1<<28) | (bit<<23) | ((width-1)<<19)) = wdata;
}

inline uint32_t BME_LAC1_W (volatile uint32_t *addr, uint8_t bit)
{
	return *(volatile uint32_t*)((uint32_t)addr | (1<<27) | (bit<<21));
}

inline uint16_t BME_LAC1_H (volatile uint16_t *addr, uint8_t bit)
{
	return *(volatile uint16_t*)((uint32_t)addr | (1<<27) | (bit<<21));
}

inline uint8_t BME_LAC1_B (volatile uint8_t *addr, uint8_t bit)
{
	return *(volatile uint8_t*)((uint32_t)addr | (1<<27) | (bit<<21));
}

inline uint32_t BME_LAS1_W (volatile uint32_t *addr, uint8_t bit)
{
	return *(volatile uint32_t*)((uint32_t)addr | (3<<26) | (bit<<21));
}

inline uint16_t BME_LAS1_H (volatile uint16_t *addr, uint8_t bit)
{
	return *(volatile uint16_t*)((uint32_t)addr | (3<<26) | (bit<<21));
}

inline uint8_t BME_LAS1_B (volatile uint8_t *addr, uint8_t bit)
{
	return *(volatile uint8_t*)((uint32_t)addr | (3<<26) | (bit<<21));
}

 
inline uint32_t BME_UBFX_W (volatile uint32_t *addr, uint8_t bit, uint8_t width)
{
	return *(volatile uint32_t*)((uint32_t)addr | (1<<28) | (bit<<23) | ((width-1)<<19));
}

inline uint16_t BME_UBFX_H (volatile uint16_t *addr, uint8_t bit, uint8_t width)
{
	return *(volatile uint16_t*)((uint32_t)addr | (1<<28) | (bit<<23) | ((width-1)<<19));
}

inline uint8_t BME_UBFX_B (volatile uint8_t *addr, uint8_t bit, uint8_t width)
{
	return *(volatile uint8_t*)((uint32_t)addr | (1<<28) | (bit<<23) | ((width-1)<<19));
}
...
void LPTMR_init( int count, int mode, int clock_source )
{
    ...
    osInstallIsr(INT_LPTimer, LPTMR_IRQHandler, (( void * )( 0x0UL )));

    ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= 1 << ((INT_LPTimer-16)%32);
    ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= 1 << ((INT_LPTimer-16)%32);

    if( 1 == mode )
    {
        ((((LPTMR_MemMapPtr)0x40040000u))->PSR) = ( (((uint32_t)(((uint32_t)(0))<<3))&0x78u)            
                     | 0x4u              
                     | (((uint32_t)(((uint32_t)(clock_source))<<0))&0x3u)) ;   

        count = count * 100;
    }
    else if( 2 == mode )
    {
        ((((LPTMR_MemMapPtr)0x40040000u))->PSR) = ( (((uint32_t)(((uint32_t)(8))<<3))&0x78u)            
                     | (((uint32_t)(((uint32_t)(clock_source))<<0))&0x3u)) ;   
    ...
    {
        ((((LPTMR_MemMapPtr)0x40040000u))->PSR) = ( (((uint32_t)(((uint32_t)(10))<<3))&0x78u)           
                     | (((uint32_t)(((uint32_t)(clock_source))<<0))&0x3u)) ;   

        count = count * 100 / 2048;
    }

    ((((LPTMR_MemMapPtr)0x40040000u))->CMR) = (((uint32_t)(((uint32_t)(count))<<0))&0xFFFFu);    

    ((((LPTMR_MemMapPtr)0x40040000u))->CSR) =(  0x80u   
                 | 0x40u   
                 | (((uint32_t)(((uint32_t)(0))<<4))&0x30u)     
                 |!0x8u   
                 |!0x4u   
                 |!0x2u   
                );
...
void LPTMR_IRQHandler( void *param )
{
    ...
    if(((((MCM_MemMapPtr)0xF0003000u))->CPO) & 0x2u)
    {
        ((((MCM_MemMapPtr)0xF0003000u))->CPO) &= ~0x1u;
        while (((((MCM_MemMapPtr)0xF0003000u))->CPO) & 0x2u);
    }
    ((((SIM_MemMapPtr)0x40047000u))->SCGC5) |= 0x1u;

    ((((LPTMR_MemMapPtr)0x40040000u))->CSR) |=  0x80u;   
    ((((LPTMR_MemMapPtr)0x40040000u))->CSR) = ( 0x1u | 0x40u | 0x80u  );

    
    
    
     
    dummyread = ((((LPTMR_MemMapPtr)0x40040000u))->CSR);
