...
{  
   ...
   if ( ((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->SIZE ) {

       
      td2_ptr    = (TD_STRUCT_PTR)((pointer)kernel_data->TIMEOUT_QUEUE.NEXT);

       
      count      = ((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->SIZE + 1;
      while ( --count ) {
       
         result = ((((PSP_TICK_STRUCT_PTR)(&td2_ptr->TIMEOUT))->TICKS[0] > ((PSP_TICK_STRUCT_PTR)(&td_ptr->TIMEOUT))->TICKS[0]) ? 1 : (((PSP_TICK_STRUCT_PTR)(&td2_ptr->TIMEOUT))->TICKS[0] < ((PSP_TICK_STRUCT_PTR)(&td_ptr->TIMEOUT))->TICKS[0]) ? -1 : 0 );
         if ((result >= 0)) {
   ...
   { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(tdprev_ptr)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(tdprev_ptr)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(tdprev_ptr)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)); }; ++((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->SIZE;;
...
{  
    ...
    if ((end_tick_ptr == ((pointer)0)) || (start_tick_ptr == ((pointer)0)) ||
                    (diff_tick_ptr == ((pointer)0)))
    {
        return ((0x0000)|0x0C);
    }  

    _psp_subtract_ticks((PSP_TICK_STRUCT_PTR)(end_tick_ptr), (PSP_TICK_STRUCT_PTR)(start_tick_ptr), (PSP_TICK_STRUCT_PTR)(diff_tick_ptr));
...
{  
    ...
    if ((end_tick_ptr == ((pointer)0)) || (start_tick_ptr == ((pointer)0)))
    {
        if (overflow_ptr != ((pointer)0)) *overflow_ptr = ((boolean)1);
        return (0x7FFFFFFFL);
    }  

    return (_psp_subtract_ticks_int32((PSP_TICK_STRUCT_PTR)(end_tick_ptr), (PSP_TICK_STRUCT_PTR)(start_tick_ptr), (boolean *)(overflow_ptr)));
}  
...
)
{
    ...
    *tick_ptr = kernel_data->TIME;
    ...
    _psp_normalize_ticks((PSP_TICK_STRUCT_PTR)(tick_ptr));
...
{  
    ...
    *tick_ptr = kernel_data->TIME;
    ...
    _psp_add_ticks((PSP_TICK_STRUCT_PTR)(tick_ptr), (PSP_TICK_STRUCT_PTR)(&kernel_data->TIME_OFFSET), (PSP_TICK_STRUCT_PTR)(tick_ptr));
...
{  
    ...
    if (ticks) {
        tick_ptr->HW_TICKS = 0;
        ((PSP_TICK_STRUCT_PTR)(tick_ptr))->TICKS[0] = ((PSP_TICK_STRUCT_PTR)(&_mqx_zero_tick_struct))->TICKS[0] + (uint_64)(ticks);
    }
    else {
...
{  
    ...
    (++(((PSP_TICK_STRUCT_PTR)(&kernel_data->TIME))->TICKS[0]));
    ...
    _psp_normalize_ticks((PSP_TICK_STRUCT_PTR)(&kernel_data->TIME));

    


 
    count = ((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->SIZE;
    if (count) {
        td_ptr = (TD_STRUCT_PTR)((pointer) kernel_data->TIMEOUT_QUEUE.NEXT);
        ++count;
        while (--count) {
            next_td_ptr = td_ptr->TD_NEXT;
            result = ((((PSP_TICK_STRUCT_PTR)(&kernel_data->TIME))->TICKS[0] > ((PSP_TICK_STRUCT_PTR)(&td_ptr->TIMEOUT))->TICKS[0]) ? 1 : (((PSP_TICK_STRUCT_PTR)(&kernel_data->TIME))->TICKS[0] < ((PSP_TICK_STRUCT_PTR)(&td_ptr->TIMEOUT))->TICKS[0]) ? -1 : 0 );
            if (result >= 0) {
                --kernel_data->TIMEOUT_QUEUE.SIZE;
                { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; };
                td_ptr->STATE &= ~(0x100);
                if (td_ptr->STATE & (0x400)) {
                    td_ptr->STATE &= ~(0x400);
    ...
    if (kernel_data->TIMER_COMPONENT_ISR != ((pointer)0)) {
        (*kernel_data->TIMER_COMPONENT_ISR)();
    } 

     
    if (kernel_data->LWTIMER_ISR != ((pointer)0)) {
...
{  
    ...
    _psp_subtract_ticks((PSP_TICK_STRUCT_PTR)(ticks), (PSP_TICK_STRUCT_PTR)(&kernel_data->TIME), (PSP_TICK_STRUCT_PTR)(&kernel_data->TIME_OFFSET));
