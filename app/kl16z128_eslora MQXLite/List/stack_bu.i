   ...
   )
{
   ...
   boolean res = ((boolean)1);

   stack_base_ptr  = (uchar_ptr)((pointer)((_mem_size)(((uchar_ptr)(stack_ptr) + stack_size - 1)) & (~((0x10)-1))));
   ...
   td_ptr->STACK_LIMIT = ((pointer)(((_mem_size)((stack_ptr)) + ((0x10)-1)) & (~((0x10)-1))));
