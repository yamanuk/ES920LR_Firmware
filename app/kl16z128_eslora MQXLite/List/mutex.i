...
{  
    ...
    if (attr_ptr == ((pointer)0))
    {
        ;
        return ((((0x0000) | 0x0400)|0x10));
    }  

    attr_ptr->SCHED_PROTOCOL   = (0x0000);
    attr_ptr->PRIORITY_CEILING = 0;
    attr_ptr->VALID            = (_mqx_uint)(0x6d757478);
    attr_ptr->COUNT            = 0;
    attr_ptr->WAIT_PROTOCOL    = (0x04);
...
{  
    ...
    if (kernel_data->KERNEL_COMPONENTS[(3)] != ((pointer)0))
    {
        ;
        return ((0));
    }  
    ...
    ((QUEUE_STRUCT_PTR)(&mutex_component_ptr->MUTEXES))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&mutex_component_ptr->MUTEXES))->NEXT); ((QUEUE_STRUCT_PTR)(&mutex_component_ptr->MUTEXES))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&mutex_component_ptr->MUTEXES))->NEXT); ((QUEUE_STRUCT_PTR)(&mutex_component_ptr->MUTEXES))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&mutex_component_ptr->MUTEXES))->MAX = (uint_16)0;
    mutex_component_ptr->VALID = (_mqx_uint)(0x6d757478);
    ...
    kernel_data->KERNEL_COMPONENTS[(3)] = mutex_component_ptr;

    kernel_data->COMPONENT_CLEANUP[(3)] = _mutex_cleanup;
...
{  
    ...
    if (attr_ptr->VALID != (_mqx_uint)(0x6d757478))
    {
        ;
        return ((((0x0000) | 0x0400)|0x10));
    }  
...
{  
    ...
    mutex_component_ptr = (MUTEX_COMPONENT_STRUCT_PTR) kernel_data->KERNEL_COMPONENTS[(3)];

    if (mutex_component_ptr->VALID != (_mqx_uint)(0x6d757478))
    {
        ;
        return (((0x0000)|0x1A));
    }  
    ...
    if (mutex_ptr->LINK.NEXT != ((pointer)0))
    {
         
        _int_disable();
        { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(mutex_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(mutex_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&mutex_component_ptr->MUTEXES))->SIZE;;
        _int_enable();
    }  

     
    while (((QUEUE_STRUCT_PTR)(&mutex_ptr->WAITING_TASKS))->SIZE)
    {
        td_ptr = (pointer)((QUEUE_STRUCT_PTR)(&mutex_ptr->WAITING_TASKS))->NEXT; { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)((&mutex_ptr->WAITING_TASKS)))->SIZE;;
        _task_set_error_td_internal(td_ptr, (((0x0000) | 0x0400)|0x10));
        _int_disable();
...
{  
    ...
    if ((attr_ptr == ((pointer)0)) || (waiting_protocol_ptr == ((pointer)0)))
    {
        return ((((0x0000) | 0x0400)|0x10));
    }  
    if (attr_ptr->VALID != (_mqx_uint)(0x6d757478))
...
{  
    ...
    if ((attr_ptr == ((pointer)0)) || (ceiling_ptr == ((pointer)0)))
    {
        return ((((0x0000) | 0x0400)|0x10));
    }  
    if (attr_ptr->VALID != (_mqx_uint)(0x6d757478))
...
{  
    ...
    if ((attr_ptr == ((pointer)0)) || (protocol_ptr == ((pointer)0)))
    {
        return ((((0x0000) | 0x0400)|0x10));
    }  
    if (attr_ptr->VALID != (_mqx_uint)(0x6d757478))
...
{  
    ...
    if ((attr_ptr == ((pointer)0)) || (spin_count_ptr == ((pointer)0)))
    {
        return ((((0x0000) | 0x0400)|0x10));
    }  
    if (attr_ptr->VALID != (_mqx_uint)(0x6d757478))
...
{  
    ...
    mutex_component_ptr = (MUTEX_COMPONENT_STRUCT_PTR) kernel_data->KERNEL_COMPONENTS[(3)];
    if (mutex_component_ptr == ((pointer)0))
    {
    ...
    mutex_ptr->VALID            = (_mqx_uint)(0x6d757478);
    mutex_ptr->COUNT            = attr_ptr->COUNT;
    mutex_ptr->PRIORITY_CEILING = attr_ptr->PRIORITY_CEILING;
    mutex_ptr->LOCK             = 0;
    mutex_ptr->BOOSTED          = 0;
    mutex_ptr->OWNER_TD         = ((pointer)0);
    ((QUEUE_STRUCT_PTR)(&mutex_ptr->WAITING_TASKS))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&mutex_ptr->WAITING_TASKS))->NEXT); ((QUEUE_STRUCT_PTR)(&mutex_ptr->WAITING_TASKS))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&mutex_ptr->WAITING_TASKS))->NEXT); ((QUEUE_STRUCT_PTR)(&mutex_ptr->WAITING_TASKS))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&mutex_ptr->WAITING_TASKS))->MAX = (uint_16)0;

    { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&mutex_component_ptr->MUTEXES)))->PREV)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((mutex_ptr))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&mutex_component_ptr->MUTEXES)))->PREV)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((mutex_ptr))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((mutex_ptr))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&mutex_component_ptr->MUTEXES)))->PREV)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((mutex_ptr))); }; ++((QUEUE_STRUCT_PTR)((&mutex_component_ptr->MUTEXES)))->SIZE;;
    _int_enable();
...
{  
    ...
    if (mutex_ptr->VALID != (_mqx_uint)(0x6d757478))
    {
        ;
        return ((((0x0000) | 0x0400)|0x10));
    }  
    ...
    {
        ;
        return ((((0x0000) | 0x0400)|0x09));
    }  

    priority = td_ptr->MY_QUEUE->PRIORITY;
    lock_ptr = &mutex_ptr->LOCK;

    if ((mutex_ptr->PROTOCOLS & (0x01)) ||
        (mutex_ptr->PROTOCOLS & (0x02)))
    {
    ...
    if (*lock_ptr)
    {
        ...
        else
        {
            ...
            { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&mutex_ptr->WAITING_TASKS)))->PREV)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&mutex_ptr->WAITING_TASKS)))->PREV)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&mutex_ptr->WAITING_TASKS)))->PREV)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))); }; ++((QUEUE_STRUCT_PTR)((&mutex_ptr->WAITING_TASKS)))->SIZE;;
        }  

         
        td_ptr->STATE = (0x22 | (0x001) | (0x200));
    ...
    if ((mutex_ptr->PROTOCOLS & (0x0100)) && !(mutex_ptr->PROTOCOLS & (0x08)))
    {
...
{  
    ...
    if (!(
    (waiting_protocol == (0x01)) ||
    (waiting_protocol == (0x02)) ||
    (waiting_protocol == (0x04)) || (waiting_protocol == (0x08))))
    {
        ;
        return ((((0x0000) | 0x0400)|0x10));
    }  
...
{  
    ...
    if (!((protocol == (0x0100)) || (protocol == (0x0200)) || (protocol == (0x0000))))
    {
        ;
        return ((((0x0000) | 0x0400)|0x10));
    }  
...
{  
    ...
    if (mutex_ptr->PROTOCOLS & ((0x01) | (0x02)))
    {
        mutex_ptr->OWNER_TD = ((pointer)0);
        mutex_ptr->LOCK = 0;
    }
    else
    {
        ...
        if (((QUEUE_STRUCT_PTR)(&mutex_ptr->WAITING_TASKS))->SIZE)
        {
...
{  
    ...
    if ((mutex_ptr == ((pointer)0)) || (old_ceiling_ptr == ((pointer)0)))
    {
        _int_enable();
        ;
        return ((((0x0000) | 0x0400)|0x10));
...
{  
    ...
    if ((mutex_ptr == ((pointer)0)) || (ceiling_ptr == ((pointer)0)))
    {
        return ((((0x0000) | 0x0400)|0x10));
    }  
    if (mutex_ptr->VALID != (_mqx_uint)(0x6d757478))
...
{  
    ...
    if (mutex_ptr == ((pointer)0))
    {
        _task_set_error((((0x0000) | 0x0400)|0x10));
        return (((0xFFFFFFFFUL)));
    }  
    if (mutex_ptr->VALID != (_mqx_uint)(0x6d757478))
    {
    ...
    return (((QUEUE_STRUCT_PTR)(&mutex_ptr->WAITING_TASKS))->SIZE);
