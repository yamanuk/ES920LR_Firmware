...
{  
    ...
    kernel_data->CONFIG1 = ( (0 ? (0x0001) : 0) | (1 ? (0x0002) : 0) | (0 ? (0x0004) : 0) | (1 ? (0x0008) : 0) | (1 ? (0x0010) : 0) | (1 ? (0x0020) : 0) | (1 ? (0x0040) : 0) | (1 ? (0x0080) : 0) | (1 ? (0x0100) : 0) | (0 ? (0x0200) : 0) | (0 ? (0x0400) : 0) | (1 ? (0x0800) : 0) | (0 ? (0x1000) : 0) | (1 ? (0x2000) : 0) | (0 ? (0x4000) : 0) | (0 ? (0x8000) : 0) );
    kernel_data->CONFIG2 = ( (0 ? (0x0001) : 0) | (0 ? (0x0002) : 0) | (1 ? (0x0004) : 0) | (1 ? (0x0008) : 0) | (0 ? (0x0010) : 0) | (0 ? (0x0020) : 0) | (1 ? (0x0040) : 0) | (0 ? (0x0080) : 0) | (0 ? (0x0100) : 0) );

     
    kernel_data->ADDRESSING_CAPABILITY = (8);

     
    kernel_data->ENDIANESS = (1);

     

    kernel_data->PSP_CFG_MEM_STOREBLOCK_ALIGNMENT = (2);

    kernel_data->PSP_CFG_MEMORY_ALIGNMENT = ((0x10)-1);
    kernel_data->PSP_CFG_STACK_ALIGNMENT = ((0x10)-1);
    ...
    if (kernel_data->INIT.TASK_TEMPLATE_LIST == ((pointer)0)) {
        _mqx_exit(((0x0000)|0x01));
    }  
    ...
    td_ptr->TASK_ID = (_task_id) (((uint_32)(kernel_data->INIT . PROCESSOR_NUMBER) << 16) | ((uint_32)(0xffff) & 0xFFFF));
    td_ptr->STATE = (0x02 | (0x001));

     
    ((QUEUE_STRUCT_PTR)(&kernel_data->LWSEM))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->LWSEM))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->LWSEM))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->LWSEM))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->LWSEM))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&kernel_data->LWSEM))->MAX = (uint_16)0;


     
    ((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->MAX = (uint_16)0;
    ...
    for (i = 0; task_template_ptr->TASK_TEMPLATE_INDEX && (i < (0xFFFF)); ++i, ++task_template_ptr) {
    ...
    task_template_ptr->TASK_TEMPLATE_INDEX  = (((_mqx_uint)(((_mqx_uint)0x1) << ((32) - 1))) | 0x3);
    ...
    ((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->MAX = (uint_16)0;
