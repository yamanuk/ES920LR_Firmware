...
)
{
    ...
    if (task_id != ((_task_id)0))
    {
        processor = ((uint_16)((task_id) >> 16));
    ...
    if ((td_ptr == ((pointer)0)) || (td_ptr == ((TD_STRUCT_PTR)(&(kernel_data)->SYSTEM_TD))))
    {
        ;
        return (((0x0000)|0x12));
    }  
    ...
    if (td_ptr == kernel_data->ACTIVE_PTR)
    {
        if (kernel_data->IN_ISR)
        {
            ...
            ((PSP_BASIC_INT_FRAME_STRUCT_PTR)(__iar_builtin_get_PSP()))->PC = (uint_32)(_task_exit_function_internal);
        }
        else
        {
    ...
    else
    {
        ...
        stack_ptr = (pointer) td_ptr->STACK_PTR;
        ((PSP_BLOCKED_STACK_STRUCT_PTR)(stack_ptr))->PC = ((uint_32)(_task_exit_function_internal));
        if (td_ptr->STATE & (0x100))
        {
             
            if ( ((TD_STRUCT_PTR)td_ptr)->STATE & (0x100) ) { { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->SIZE;; ((TD_STRUCT_PTR)td_ptr)->STATE &= ~(0x100); ((TD_STRUCT_PTR)td_ptr)->STATE |= (0x02 | (0x001)); };
        }
        else if (td_ptr->STATE & (0x200))
        {
            { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(td_ptr->INFO))->SIZE;;
        }
        else if ((td_ptr->STATE & ((0x400)|(0x001))) == ((0x400)|(0x001)))
        {
            
 
            { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&td_ptr->AUX_QUEUE)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&td_ptr->AUX_QUEUE)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(td_ptr->INFO))->SIZE;;
        }  
        if (td_ptr->STATE & (0x001))
        {
            _task_ready(td_ptr);
        }  
        _int_enable();
...
)
{
    ...
    return _task_abort_internal(task_id, ((boolean)0));
}
...
{  
    ...
    if (template_index & ((_mqx_uint)(((_mqx_uint)0x1) << ((32) - 1))))
    {
        _task_set_error(((0x0000)|0x15));
        ;
        return ((_task_id)0);
    }  
    ...
    {
        _task_set_error(((0x0000)|0x13));
        ;
        return ((_task_id)0);
    }  

    td_ptr = _task_build_internal(template_index, parameter, stack_ptr, stack_size, ((boolean)0));
    if (td_ptr != ((pointer)0))
    {
        result = td_ptr->TASK_ID;
        if (kernel_data->ACTIVE_PTR->DISABLED_LEVEL == 0) { __asm volatile ("cpsid i"); } ++kernel_data->ACTIVE_PTR->DISABLED_LEVEL;;
        _task_ready_internal(td_ptr);
        if (kernel_data->ACTIVE_PTR->DISABLED_LEVEL) { if (--kernel_data->ACTIVE_PTR->DISABLED_LEVEL == 0) { if (kernel_data->IN_ISR) { __asm volatile ("cpsie i"); } else { __asm volatile ("cpsie i"); } } };
...
)
{
    ...
    if ((victim_ptr == ((pointer)0)) || (victim_ptr == ((TD_STRUCT_PTR)(&(kernel_data)->SYSTEM_TD)))) {
        ;
        return ((0x0000)|0x12);
    }  
    ...
    if (victim_ptr->STATE == (0x08 | (0x001))) {
    ...
    if (victim_ptr->STATE == (0x02)) {
        if (victim_ptr != kernel_data->ACTIVE_PTR) {
             
            { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(victim_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(victim_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; };
        }  
    } else if (victim_ptr->STATE & (0x100)) {
         
        if ( ((TD_STRUCT_PTR)victim_ptr)->STATE & (0x100) ) { { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(victim_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(victim_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->SIZE;; ((TD_STRUCT_PTR)victim_ptr)->STATE &= ~(0x100); ((TD_STRUCT_PTR)victim_ptr)->STATE |= (0x02 | (0x001)); };
    } else if (victim_ptr->STATE & (0x200)) {
        



 
        { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(victim_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(victim_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(victim_ptr->INFO))->SIZE;;
    }  

    if (victim_ptr->STATE & (0x400)) {
        



 
        { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&victim_ptr->AUX_QUEUE)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&victim_ptr->AUX_QUEUE)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(victim_ptr->INFO))->SIZE;;
    }  

    victim_ptr->STATE   = (0x08 | (0x001));
...

    {
        _mqx_uint i;
        for (i = 0; i < (16); ++i) {
            if (kernel_data->COMPONENT_CLEANUP[i] != ((pointer)0)) {
    ...
    task_num = ((uint_16)((victim_ptr->TASK_ID) & 0xFFFF));

    td_ptr = kernel_data->ACTIVE_PTR;


    victim_ptr->TASK_ID = (0x80000000);

     
     
    if (((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->SIZE == 1) {
         
        kernel_data->TASK_NUMBER   = 1;
        kernel_data->INSERT_TD_PTR = ((pointer)0);
        ...
        kernel_data->INSERT_TD_PTR =
                        (TD_STRUCT_PTR)((uchar_ptr)victim_ptr->TD_LIST_INFO.PREV -
                                        (_mqx_uint)&(((TD_STRUCT *)0)->TD_LIST_INFO));
    }  
    { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&victim_ptr->TD_LIST_INFO)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&victim_ptr->TD_LIST_INFO)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->SIZE;;
...
)
{
    ...
    return _task_destroy_internal(task_id, ((boolean)0));
}
...
{  
    ...
    td_ptr = (TD_STRUCT_PTR)((uchar_ptr)kernel_data->TD_LIST.NEXT -
             (_mqx_uint)&(((TD_STRUCT *)0)->TD_LIST_INFO));
    size   = ((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->SIZE;
...
{  
    ...
    return (td_ptr ? td_ptr->TASK_TEMPLATE_PTR : ((pointer)0));
...
{  
    ...
    {
        if (task_template_ptr->TASK_NAME != ((pointer)0))
        {
...
{  
    ...
    *priority_ptr = td_ptr->HOME_QUEUE->PRIORITY;
    ...
    if (td_ptr->STATE == (0x28 | (0x001) | (0x200)))
    {
        task_queue_ptr = (TASK_QUEUE_STRUCT_PTR)
                         ((uchar_ptr)td_ptr->INFO - (_mqx_uint)&(((TASK_QUEUE_STRUCT *)0)->TD_QUEUE));
        if (task_queue_ptr->POLICY & (0x08))
        {
             
            { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&task_queue_ptr->TD_QUEUE))->SIZE;;
...
)
{
    ...
    if (((uint_16)((td_ptr->TASK_ID) >> 16)) != kernel_data->INIT.PROCESSOR_NUMBER)
    {
        ;
        _task_set_error(((0x0000)|0x12));
        ;
    ...
    if (td_ptr->STATE == (0x02))
    {
         
        _int_enable();
        ;
        _task_set_error(((0x0000)|0x11));
        ;
        return;
    } 
...
{  
    ...
    if (victim_ptr == ((pointer)0))
    {
        ;
        return(((0x0000)|0x12));
    }  

    if (victim_ptr == ((TD_STRUCT_PTR)(&(kernel_data)->SYSTEM_TD)))
    {
        ;
        return(((0x0000)|0x12));
    }  
    ...
    if (victim_ptr->STACK_ALLOC_BLOCK)    {
        stack_ptr = victim_ptr->STACK_ALLOC_BLOCK;
    }
    else    {
    ...
    if ( stack_size <= (sizeof(PSP_STACK_START_STRUCT) + (64) + (0))  )
    {
        stack_size = (sizeof(PSP_STACK_START_STRUCT) + (64) + (0));
    }  

     
    stack_size = (((_mem_size)(stack_size) + ((0x10)-1)) & (~((0x10)-1)));
    ...
    if (((boolean)0) == _psp_build_stack_frame(victim_ptr, stack_ptr, stack_size, template_ptr, victim_ptr->TASK_SR, create_param))
    {
...
)
{
    ...
    td_ptr = (TD_STRUCT_PTR)((uchar_ptr)kernel_data->TD_LIST.NEXT - (_mqx_uint)&(((TD_STRUCT *)0)->TD_LIST_INFO));
    ...
    while (size--)
    {
        ...
        td_ptr = (TD_STRUCT_PTR)((uchar_ptr)td_ptr->TD_LIST_INFO.NEXT - (_mqx_uint)&(((TD_STRUCT *)0)->TD_LIST_INFO));
    }  
...
{  
    ...
    if (( new_error_code == (0) ) || ( old_error_code == (0) ))
    {
        if (kernel_data->IN_ISR)
        {
...
)
{
    ...
    if (task_template_ptr == ((pointer)0))
    {
        _task_set_error(((0x0000)|0x10));
        return ((pointer)0);
    }  
    ...
    td_ptr = _task_init_internal(task_template_ptr, kernel_data->ACTIVE_PTR->TASK_ID,                     create_parameter, dynamic, stack_ptr, stack_size);
...
extern void _task_exiting_function_internal(void);   
...
void _task_exit_function_internal(void)
{
    ...
    if (td_ptr->EXIT_HANDLER_PTR != ((pointer)0))
    {
        (*td_ptr->EXIT_HANDLER_PTR)();
    }
    (void)_task_destroy(((_task_id)0));  
}
...
{  
    ...
    if (input_stack_ptr)
    {
        ...
        if (stack_size <= ((sizeof(PSP_STACK_START_STRUCT) + (64) + (0))+sizeof(TD_STRUCT)))
        {
            _task_set_error(((0x0000)|0x02));
            return(((pointer)0));
        }  
        td_ptr = _task_alloc_td_internal(stack_size, &td_size, input_stack_ptr, template_ptr->TASK_ATTRIBUTES & (0));
        stack_size -= td_size;
    ...
    else
    {
        ...
        td_ptr = _task_alloc_td_internal(dynamic ? (stack_size +  sizeof(TASK_TEMPLATE_STRUCT)) : stack_size,
                                                 &td_size, ((pointer)0), template_ptr->TASK_ATTRIBUTES & (0));
    } 


    td_ptr->STATE = (0x02 | (0x001));
    ...
    if (dynamic)
    {
        ...
        *new_template_ptr = *template_ptr;
        ...
        template_ptr->TASK_TEMPLATE_INDEX |= ((_mqx_uint)(((_mqx_uint)0x1) << ((32) - 1)));
    ...
    if (((boolean)0) == _psp_build_stack_frame(td_ptr, stack_ptr, stack_size, template_ptr, (_mqx_uint)ready_q_ptr->ENABLE_SR, create_parameter))
    {
...
{  
    ...
    size = (size/sizeof(_mqx_uint)) + 1;   
    while (--size)
    {
        *addr_ptr++ = (_mqx_uint)(0x7374616B);
    }  
...
{  
    ...
    if (((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->SIZE >= ((0xFFFF)-1))
    {
    ...
    *overhead = extra;
    ...
    new_td_ptr->TASK_ID = (_task_id) (((uint_32)(kernel_data->INIT . PROCESSOR_NUMBER) << 16) | ((uint_32)(task_num) & 0xFFFF));
    ...
    { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(q_ptr)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&new_td_ptr->TD_LIST_INFO)))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(q_ptr)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&new_td_ptr->TD_LIST_INFO)); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&new_td_ptr->TD_LIST_INFO)))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(q_ptr)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(&new_td_ptr->TD_LIST_INFO)); }; ++((QUEUE_STRUCT_PTR)(&kernel_data->TD_LIST))->SIZE;;
    ...
    do
    {
        ...
        next_td_ptr   = (TD_STRUCT_PTR)((uchar_ptr)insert_td_ptr->TD_LIST_INFO.NEXT - (_mqx_uint)&(((TD_STRUCT *)0)->TD_LIST_INFO));
        prev_td_ptr   = next_td_ptr;
        task_num++; if (task_num == 0) { task_num = 1; };
    } while( ((pointer)next_td_ptr != ((pointer)&kernel_data->TD_LIST)) &&
                    (((uint_16)((next_td_ptr->TASK_ID) & 0xFFFF)) == task_num) );
