...
typedef SystemTimer1_TDeviceData *SystemTimer1_TDeviceDataPtr;  
...
LDD_TDeviceData* SystemTimer1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv->SavedISRSettings_TUInterrupt.isrData = _int_get_isr_data(0x0Fu);
  DeviceDataPrv->SavedISRSettings_TUInterrupt.isrFunction = _int_install_isr(0x0Fu, SystemTimer1_Interrupt, DeviceDataPrv);
   
  ((((SysTick_MemMapPtr)0xE000E010u))->CSR) = 0x00U;                     
   
  ((((SysTick_MemMapPtr)0xE000E010u))->RVR) = (((uint32_t)(((uint32_t)(0x00005DC0))<<0))&0xFFFFFFu);  
   
  ((((SysTick_MemMapPtr)0xE000E010u))->CVR) = (((uint32_t)(((uint32_t)(0x00))<<0))&0xFFFFFFu);  
   
  ((((SCB_MemMapPtr)0xE000E000u))->SHPR3) = (uint32_t)((((((SCB_MemMapPtr)0xE000E000u))->SHPR3) & (uint32_t)~(uint32_t)(
               (((uint32_t)(((uint32_t)(0x7F))<<24))&0xFF000000u)
              )) | (uint32_t)(
               (((uint32_t)(((uint32_t)(0x80))<<24))&0xFF000000u)
              ));
   
  ((((SysTick_MemMapPtr)0xE000E010u))->CSR) = 0x2u;  
  DeviceDataPrv->EnUser = ((boolean)0);        
  DeviceDataPrv->LastClock = (LDD_TClockConfiguration)0xFFU;  
  SystemTimer1_SetClockConfiguration(DeviceDataPrv, Cpu_GetClockConfiguration());  
   
  (PE_LDD_DeviceDataList[0x00U] = DeviceDataPrv);
...
void SystemTimer1_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)DeviceDataPrv;
  ( ((((SysTick_MemMapPtr)0xE000E010u))->CSR) = (uint32_t)(( (uint32_t)(( ((((SysTick_MemMapPtr)0xE000E010u))->CSR)) & ( (uint32_t)(~(uint32_t)0x1u)))) | ( (uint32_t)(0u))) );
   
   
   
  (void)_int_install_isr(0x0Fu, ((SystemTimer1_TDeviceDataPtr)DeviceDataPrv)->SavedISRSettings_TUInterrupt.isrFunction, ((SystemTimer1_TDeviceDataPtr)DeviceDataPrv)->SavedISRSettings_TUInterrupt.isrData);
   
  (PE_LDD_DeviceDataList[0x00U] = ((pointer)0));
...
LDD_TError SystemTimer1_SetPeriodTicks(LDD_TDeviceData *DeviceDataPtr, SystemTimer1_TValueType Ticks)
{
  ...
  ( ((((SysTick_MemMapPtr)0xE000E010u))->RVR) = (uint32_t)((uint32_t)(--Ticks)) );
  return 0x00U;                        
}
...
LDD_TError SystemTimer1_GetPeriodTicks(LDD_TDeviceData *DeviceDataPtr, SystemTimer1_TValueType *TicksPtr)
{
  ...
  tmp = (SystemTimer1_TValueType)(( ((((SysTick_MemMapPtr)0xE000E010u))->RVR) ));
...
LDD_TError SystemTimer1_ResetCounter(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  _int_disable();
  if ((( (uint32_t)(((((SysTick_MemMapPtr)0xE000E010u))->CSR) & 0x1u) )) != 0U) {
    ( ((((SysTick_MemMapPtr)0xE000E010u))->CSR) = (uint32_t)(( (uint32_t)(( ((((SysTick_MemMapPtr)0xE000E010u))->CSR)) & ( (uint32_t)(~(uint32_t)0x1u)))) | ( (uint32_t)(0u))) );
    ( ((((SysTick_MemMapPtr)0xE000E010u))->CSR) = (uint32_t)(( (uint32_t)(( ((((SysTick_MemMapPtr)0xE000E010u))->CSR)) & ( (uint32_t)(~(uint32_t)0x1u)))) | ( (uint32_t)(1u))) );
  }
...
{
  (void)DeviceDataPtr;                  
  return (SystemTimer1_TValueType)( ((((SysTick_MemMapPtr)0xE000E010u))->CVR) );
}
...
void SystemTimer1_SetClockConfiguration(LDD_TDeviceData *DeviceDataPtr, LDD_TClockConfiguration ClockConfiguration)
{
  ...
  switch (ClockConfiguration) {
    case 0x00U:
      ...
      ( ((((SysTick_MemMapPtr)0xE000E010u))->CSR) = (uint32_t)(( (uint32_t)(( ((((SysTick_MemMapPtr)0xE000E010u))->CSR)) & ( (uint32_t)(~(uint32_t)0x4u)))) | ( (uint32_t)((uint32_t)(0x1U) << 2))) );  
  ...
  if (DeviceDataPrv->EnMode) {
    ...
    if (OldConst != NewConst) {         
      OldRegVal = (uint32_t)(( ((((SysTick_MemMapPtr)0xE000E010u))->RVR) ));
      NewRegVal = (uint32_t)(((((LDD_TimerUnit_Tfloat)(OldRegVal) + 1U)) * (NewConst / OldConst)) - 1U);  
      if (NewRegVal > 0x00FFFFFFUL) {   
        ( ((((SysTick_MemMapPtr)0xE000E010u))->RVR) = (uint32_t)(0x00FFFFFFUL) );  
      }
      else {
        ( ((((SysTick_MemMapPtr)0xE000E010u))->RVR) = (uint32_t)(NewRegVal) );
      }
    }
...
LDD_TError SystemTimer1_SetOperationMode(LDD_TDeviceData *DeviceDataPtr, LDD_TDriverOperationMode OperationMode, LDD_TCallback ModeChangeCallback, LDD_TCallbackParam *ModeChangeCallbackParamPtr)
{
  ...
  if (ModeChangeCallback != ((pointer)0)) {
...
void SystemTimer1_Interrupt(LDD_RTOS_TISRParameter _isrParameter)
{
  ...
  ( ((((SysTick_MemMapPtr)0xE000E010u))->CSR) &= (uint32_t)(~(uint32_t)0x10000u) );  
  SystemTimer1_OnCounterRestart(DeviceDataPrv->UserDataPtr);  
}
