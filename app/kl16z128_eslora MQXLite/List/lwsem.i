...
)
{
    ...
    ((QUEUE_STRUCT_PTR)(&sem_ptr->TD_QUEUE))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&sem_ptr->TD_QUEUE))->NEXT); ((QUEUE_STRUCT_PTR)(&sem_ptr->TD_QUEUE))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&sem_ptr->TD_QUEUE))->NEXT); ((QUEUE_STRUCT_PTR)(&sem_ptr->TD_QUEUE))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&sem_ptr->TD_QUEUE))->MAX = (uint_16)0;
    _int_disable();
    ...
    if (!hidden)
    {
        ...
        {
            { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWSEM)))->PREV)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((sem_ptr))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWSEM)))->PREV)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((sem_ptr))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((sem_ptr))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWSEM)))->PREV)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((sem_ptr))); }; ++((QUEUE_STRUCT_PTR)((&kernel_data->LWSEM)))->SIZE;;
        }
    }

    sem_ptr->VALID = (_mqx_uint)(0x6C77736D);
    _int_enable();
...
)
{
    ...
    return _lwsem_create_internal(sem_ptr, initial_number, ((boolean)0), ((boolean)0));
}
...
{
    return _lwsem_create_internal(sem_ptr, initial_number, ((boolean)1), ((boolean)0));
}
...
{  
    ...
    _int_disable();
    if (sem_ptr->VALID != (_mqx_uint)(0x6C77736D))
    {
        _int_enable();
        ;
        return (((0x0000)|0x1F));
    ...
    sem_ptr->VALID = 0;  
    while (((QUEUE_STRUCT_PTR)(&sem_ptr->TD_QUEUE))->SIZE)
    {
        td_ptr = (pointer)((QUEUE_STRUCT_PTR)(&sem_ptr->TD_QUEUE))->NEXT; { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)((&sem_ptr->TD_QUEUE)))->SIZE;;
     ...
     
    {
        ...
        while (sem_chk_ptr != (LWSEM_STRUCT_PTR) ((pointer) &kernel_data->LWSEM))
        {
            if (sem_chk_ptr == sem_ptr)
            {
                ...
                { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(sem_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(sem_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&kernel_data->LWSEM))->SIZE;;
                break;
            }  
            sem_chk_ptr = (LWSEM_STRUCT_PTR) ((pointer) sem_chk_ptr->NEXT);
        }  
...
)
{
    ...
    return _lwsem_destroy_internal(sem_ptr, ((boolean)0));
}
...
{  
    ...
    if (kernel_data->ACTIVE_PTR->DISABLED_LEVEL == 0) { __asm volatile ("cpsid i"); } ++kernel_data->ACTIVE_PTR->DISABLED_LEVEL;;
    if ((sem_ptr->VALUE >= 0) && (((QUEUE_STRUCT_PTR)(&sem_ptr->TD_QUEUE))->SIZE))
    {
        td_ptr = (pointer)((QUEUE_STRUCT_PTR)(&sem_ptr->TD_QUEUE))->NEXT; { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)((&sem_ptr->TD_QUEUE)))->SIZE;;
        td_ptr = (TD_STRUCT *)((uchar_ptr)td_ptr - (_mqx_uint)&(((TD_STRUCT *)0)->AUX_QUEUE));
        if ( ((TD_STRUCT_PTR)td_ptr)->STATE & (0x100) ) { { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->SIZE;; ((TD_STRUCT_PTR)td_ptr)->STATE &= ~(0x100); ((TD_STRUCT_PTR)td_ptr)->STATE |= (0x02 | (0x001)); };
...
{  
    ...
    *lwsem_error_ptr = ((pointer)0);
    ...
    queue_size = ((QUEUE_STRUCT_PTR)(&kernel_data->LWSEM))->SIZE;
    while (queue_size--)
    {
        if (sem_ptr->VALID != (_mqx_uint)(0x6C77736D))
        {
...
{  
    ...
    if (sem_ptr->VALUE <= 0)
    {
        ...
        { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&sem_ptr->TD_QUEUE)))->PREV)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&sem_ptr->TD_QUEUE)))->PREV)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&sem_ptr->TD_QUEUE)))->PREV)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))); }; ++((QUEUE_STRUCT_PTR)((&sem_ptr->TD_QUEUE)))->SIZE;;
...
{  
    ...
    if (sem_ptr->VALUE <= 0)
    {
        ...
        _psp_add_ticks((PSP_TICK_STRUCT_PTR)(ticks), (PSP_TICK_STRUCT_PTR)(&kernel_data->TIME), (PSP_TICK_STRUCT_PTR)(&td_ptr->TIMEOUT));
...
{  
    ...
    if (sem_ptr->VALUE <= 0)
    {
        ...
        {
            ((PSP_TICK_STRUCT_PTR)(&td_ptr->TIMEOUT))->TICKS[0] = ((PSP_TICK_STRUCT_PTR)(&kernel_data->TIME))->TICKS[0] + (uint_64)(time_in_ticks);
            result = _lwsem_wait_timed_internal(sem_ptr, td_ptr);
        }  
    }
    else
