...
{  
    ...
    count = ((QUEUE_STRUCT_PTR)(queue_ptr))->SIZE + 1;
    ...
    { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((QUEUE_ELEMENT_STRUCT_PTR)((pointer)td_prev_ptr))))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((QUEUE_ELEMENT_STRUCT_PTR)((pointer)td_ptr))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((QUEUE_ELEMENT_STRUCT_PTR)((pointer)td_prev_ptr))))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((QUEUE_ELEMENT_STRUCT_PTR)((pointer)td_ptr))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((QUEUE_ELEMENT_STRUCT_PTR)((pointer)td_ptr))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((QUEUE_ELEMENT_STRUCT_PTR)((pointer)td_prev_ptr))); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((QUEUE_ELEMENT_STRUCT_PTR)((pointer)td_ptr))); }; ++((QUEUE_STRUCT_PTR)(queue_ptr))->SIZE;;
