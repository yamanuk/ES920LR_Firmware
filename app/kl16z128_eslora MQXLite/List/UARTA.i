...
LDD_TDeviceData* UARTA_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv->InpRecvDataNum = 0x00U;  
  DeviceDataPrv->InpDataNumReq = 0x00U;  
  DeviceDataPrv->InpDataPtr = ((pointer)0);     
   
  DeviceDataPrv->OutSentDataNum = 0x00U;  
  DeviceDataPrv->OutDataNumReq = 0x00U;  
  DeviceDataPrv->OutDataPtr = ((pointer)0);     
  DeviceDataPrv->UserDataPtr = UserDataPtr;  
   
   
   
  DeviceDataPrv->SavedISRSettings.isrData = _int_get_isr_data(0x1Cu);
  DeviceDataPrv->SavedISRSettings.isrFunction = _int_install_isr(0x1Cu, UARTA_Interrupt, DeviceDataPrv);
   
  ((((SIM_MemMapPtr)0x40047000u))->SCGC4) |= 0x400u;
   
  ((((PORT_MemMapPtr)0x40049000u))->PCR[1]) = (uint32_t)((((((PORT_MemMapPtr)0x40049000u))->PCR[1]) & (uint32_t)~(uint32_t)(
                0x1000000u |
                (((uint32_t)(((uint32_t)(0x05))<<8))&0x700u)
               )) | (uint32_t)(
                (((uint32_t)(((uint32_t)(0x02))<<8))&0x700u)
               ));
   
  ((((PORT_MemMapPtr)0x40049000u))->PCR[2]) = (uint32_t)((((((PORT_MemMapPtr)0x40049000u))->PCR[2]) & (uint32_t)~(uint32_t)(
                0x1000000u |
                (((uint32_t)(((uint32_t)(0x05))<<8))&0x700u)
               )) | (uint32_t)(
                (((uint32_t)(((uint32_t)(0x02))<<8))&0x700u)
  ...
  ((((NVIC_MemMapPtr)0xE000E100u))->IP[3]) = (uint32_t)((((((NVIC_MemMapPtr)0xE000E100u))->IP[3]) & (uint32_t)~(uint32_t)(
               (((uint32_t)(((uint32_t)(0x7F))<<0))&0xFFu)
              )) | (uint32_t)(
               (((uint32_t)(((uint32_t)(0x80))<<0))&0xFFu)
              ));
   
  ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (((uint32_t)(((uint32_t)(0x1000))<<0))&0xFFFFFFFFu);
  ( ((((UART0_MemMapPtr)0x4006A000u))->C2) = (uint8_t)(( (uint8_t)(((((UART0_MemMapPtr)0x4006A000u))->C2) & (uint8_t)(~(uint8_t)0x8u))) | ( (uint8_t)((uint8_t)(0u) << 3))) );  
  ( ((((UART0_MemMapPtr)0x4006A000u))->C2) = (uint8_t)(( (uint8_t)(((((UART0_MemMapPtr)0x4006A000u))->C2) & (uint8_t)(~(uint8_t)0x4u))) | ( (uint8_t)((uint8_t)(0u) << 2))) );  
  DeviceDataPrv->BaudDivisorSpeed1 = 0x1388u;  
  DeviceDataPrv->BaudMode = 0u;  
  DeviceDataPrv->SerFlag = 0x00U;       
   
  ((((UART0_MemMapPtr)0x4006A000u))->C1) = 0x00U;                     
   
  ((((UART0_MemMapPtr)0x4006A000u))->C3) = 0x00U;                     
   
  ((((UART0_MemMapPtr)0x4006A000u))->C4) = (((uint8_t)(((uint8_t)(0x00))<<0))&0x1Fu);        
   
  ((((UART0_MemMapPtr)0x4006A000u))->S2) = 0x00U;                     
  UARTA_SetClockConfiguration(DeviceDataPrv, Cpu_GetClockConfiguration());  
   
  (PE_LDD_DeviceDataList[0x02U] = DeviceDataPrv);
...
LDD_TError UARTA_ReceiveBlock(LDD_TDeviceData *DeviceDataPtr, LDD_TData *BufferPtr, uint16_t Size)
{
  ...
  DeviceDataPrv->InpDataNumReq = Size;  
  DeviceDataPrv->InpRecvDataNum = 0x00U;  
...
LDD_TError UARTA_SendBlock(LDD_TDeviceData *DeviceDataPtr, LDD_TData *BufferPtr, uint16_t Size)
{
  ...
  DeviceDataPrv->OutDataNumReq = Size;  
  DeviceDataPrv->OutSentDataNum = 0x00U;  
  DeviceDataPrv->SerFlag |= 0x01U;  
  ( (((((UART0_MemMapPtr)0x4006A000u))->C2) |= (uint8_t)((uint8_t)(0x80u) & (uint8_t)(~(uint8_t)0xFU))), (((((UART0_MemMapPtr)0x4006A000u))->C3) |= (uint8_t)((uint8_t)(0x80u) & 0xFU)) );  
...
LDD_TError UARTA_SelectBaudRate(LDD_TDeviceData *DeviceDataPtr, LDD_SERIAL_TBaudMode Mode)
{
  ...
  DeviceDataPrv->BaudDivisorSpeed1 = UARTA_BaudDivisorSpeed1[Mode];  
  switch (Cpu_GetClockConfiguration()) {
    case 0x00U:
    case 0x01U:
      ( (((((UART0_MemMapPtr)0x4006A000u))->BDH) = (uint8_t)(( (uint8_t)(((((UART0_MemMapPtr)0x4006A000u))->BDH) & (uint8_t)(~(uint8_t)0x1Fu))) | ( (uint8_t)((uint16_t)(DeviceDataPrv->BaudDivisorSpeed1) >> 8U)))), (((((UART0_MemMapPtr)0x4006A000u))->BDL) = (uint8_t)(DeviceDataPrv->BaudDivisorSpeed1)) );  
      break;
    default:
      break;
  }
...
static void HWEnDi(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  if (DeviceDataPrv->EnMode) {          
    ( ((((UART0_MemMapPtr)0x4006A000u))->C2) = (uint8_t)(( (uint8_t)(((((UART0_MemMapPtr)0x4006A000u))->C2) & (uint8_t)(~(uint8_t)0x8u))) | ( (uint8_t)((uint8_t)(1u) << 3))) );  
    ( ((((UART0_MemMapPtr)0x4006A000u))->C2) = (uint8_t)(( (uint8_t)(((((UART0_MemMapPtr)0x4006A000u))->C2) & (uint8_t)(~(uint8_t)0x4u))) | ( (uint8_t)((uint8_t)(1u) << 2))) );  
    ( (((((UART0_MemMapPtr)0x4006A000u))->C2) |= (uint8_t)((uint8_t)(( 0x20u )) & (uint8_t)(~(uint8_t)0xFU))), (((((UART0_MemMapPtr)0x4006A000u))->C3) |= (uint8_t)((uint8_t)(( 0x20u )) & 0xFU)) );  
  } else {
    ( (((((UART0_MemMapPtr)0x4006A000u))->C2) &= (uint8_t)(~(uint8_t)((uint8_t)(( 0x20u | 0x80u )) & (uint8_t)(~(uint8_t)0xFU)))), (((((UART0_MemMapPtr)0x4006A000u))->C3) &= (uint8_t)(~(uint8_t)((uint8_t)(( 0x20u | 0x80u )) & 0xFU))) );  
    ( ((((UART0_MemMapPtr)0x4006A000u))->C2) = (uint8_t)(( (uint8_t)(((((UART0_MemMapPtr)0x4006A000u))->C2) & (uint8_t)(~(uint8_t)0x8u))) | ( (uint8_t)((uint8_t)(0u) << 3))) );  
    ( ((((UART0_MemMapPtr)0x4006A000u))->C2) = (uint8_t)(( (uint8_t)(((((UART0_MemMapPtr)0x4006A000u))->C2) & (uint8_t)(~(uint8_t)0x4u))) | ( (uint8_t)((uint8_t)(0u) << 2))) );  
  }
}
...
static void InterruptRx(UARTA_TDeviceDataPtr DeviceDataPrv)
{
  ...
  Data = (uint16_t)( ((((UART0_MemMapPtr)0x4006A000u))->D) );  
  if (DeviceDataPrv->InpDataNumReq != 0x00U) {  
    *(DeviceDataPrv->InpDataPtr++) = (uint8_t)Data;  
    DeviceDataPrv->InpRecvDataNum++;    
    if (DeviceDataPrv->InpRecvDataNum == DeviceDataPrv->InpDataNumReq) {  
      DeviceDataPrv->InpDataNumReq = 0x00U;  
...
static void InterruptTx(UARTA_TDeviceDataPtr DeviceDataPrv)
{
  ...
  if (DeviceDataPrv->OutSentDataNum < DeviceDataPrv->OutDataNumReq) {  
    ( ((((UART0_MemMapPtr)0x4006A000u))->D) = (uint8_t)(*(DeviceDataPrv->OutDataPtr++)) );  
    ...
    ( (((((UART0_MemMapPtr)0x4006A000u))->C2) &= (uint8_t)(~(uint8_t)((uint8_t)(0x80u) & (uint8_t)(~(uint8_t)0xFU)))), (((((UART0_MemMapPtr)0x4006A000u))->C3) &= (uint8_t)(~(uint8_t)((uint8_t)(0x80u) & 0xFU))) );  
    DeviceDataPrv->SerFlag &= (uint16_t)(~(uint16_t)0x01U);  
  }
}
...
void UARTA_Interrupt(LDD_RTOS_TISRParameter _isrParameter)
{
  ...
  register uint16_t StatReg = ( ((((UART0_MemMapPtr)0x4006A000u))->S1) );  

  if (StatReg & (0x4u | 0x8u | 0x2u | 0x1u)) {  
    ( ((((UART0_MemMapPtr)0x4006A000u))->S1) = (uint8_t)((0x4u | 0x8u | 0x2u | 0x1u)) );
    (void)( ((((UART0_MemMapPtr)0x4006A000u))->D) );  
    StatReg &= (uint16_t)(~(uint16_t)0x20u);  
  }
  if (StatReg & 0x20u) {   
    InterruptRx(DeviceDataPrv);         
  }
  if (DeviceDataPrv->SerFlag & 0x01U) {  
    if (StatReg & 0x80u) {  
      InterruptTx(DeviceDataPrv);       
    }
  }
}
...
void UARTA_SetClockConfiguration(LDD_TDeviceData *DeviceDataPtr, LDD_TClockConfiguration ClockConfiguration)
{
  ...
  switch (ClockConfiguration) {
    case 0x00U:
    case 0x01U:
      ( ((((SIM_MemMapPtr)0x40047000u))->SOPT2) = (( (uint32_t)(((((SIM_MemMapPtr)0x40047000u))->SOPT2) & (uint32_t)(~(uint32_t)0xC000000u))) | ( (uint32_t)((uint32_t)(0x1U) << 26))) );
      ( (((((UART0_MemMapPtr)0x4006A000u))->BDH) = (uint8_t)(( (uint8_t)(((((UART0_MemMapPtr)0x4006A000u))->BDH) & (uint8_t)(~(uint8_t)0x1Fu))) | ( (uint8_t)((uint16_t)(DeviceDataPrv->BaudDivisorSpeed1) >> 8U)))), (((((UART0_MemMapPtr)0x4006A000u))->BDL) = (uint8_t)(DeviceDataPrv->BaudDivisorSpeed1)) );  
      ( ((((UART0_MemMapPtr)0x4006A000u))->C4) = (uint8_t)(( (uint8_t)(((((UART0_MemMapPtr)0x4006A000u))->C4) & (uint8_t)(~(uint8_t)0x1Fu))) | ( (uint8_t)(3U))) );
      ( ((((UART0_MemMapPtr)0x4006A000u))->C5) = (uint8_t)(( (uint8_t)(((((UART0_MemMapPtr)0x4006A000u))->C5) & (uint8_t)(~(uint8_t)0x2u))) | ( (uint8_t)((uint8_t)(1u) << 1))) );
