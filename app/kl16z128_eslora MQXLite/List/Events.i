...
void (*StackTimer_OnChannel0_Notify_fptr)(LDD_TUserData*) = ((pointer)0);
void (*SerialManager_RxNotify_fptr)(LDD_TUserData*) = ((pointer)0);
void (*SerialManager_TxNotify_fptr)(LDD_TUserData*) = ((pointer)0);
void (*SerialManager_IICErrorNotify_fptr)(LDD_TUserData*) = ((pointer)0);
void (*DataAvailableCallback_fptr)(LDD_TUserData*) = ((pointer)0);
void (*PrecisionTimer_OnCounterRestart_fptr)(LDD_TUserData*) = ((pointer)0);
void (*RealTimeClock_OnAlarm_fptr)(LDD_TUserData*) = ((pointer)0);
...
void UARTA_OnBlockReceived(LDD_TUserData *UserDataPtr)
{
    ...
    if(SerialManager_RxNotify_fptr != ((pointer)0))
    {
...
void UARTA_OnBlockSent(LDD_TUserData *UserDataPtr)
{
    ...
    if(SerialManager_TxNotify_fptr != ((pointer)0))
    {
...
void StackTimer_OnChannel0(LDD_TUserData *UserDataPtr)
{
    ...
    if(StackTimer_OnChannel0_Notify_fptr != ((pointer)0))
    {
...
void Cpu_OnReset(uint16_t Reason)
{
    ...
    Cpu_SetClockConfiguration(0x00U);

    SystemTimer1_Enable(PE_LDD_DeviceDataList[0x00U]);  
}
...
void I2CDriver_OnError(LDD_TUserData *UserDataPtr)
{
    ...
    if(SerialManager_IICErrorNotify_fptr != ((pointer)0))
    {
...
void DataAvailablePin_OnPortEvent(LDD_TUserData *UserDataPtr)
{
    ...
    if(DataAvailableCallback_fptr != ((pointer)0))
    {
...
void RealTimeClock_OnAlarm(LDD_TUserData *UserDataPtr)
{
    ...
    if(RealTimeClock_OnAlarm_fptr != ((pointer)0))
    {
