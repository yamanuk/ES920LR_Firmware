...
typedef struct {
  bool                       EnUser;              
  LDD_TUserData           *UserDataPtr;           
  LDD_RTOS_TISRVectorSettings SavedISRSettings_RTC_ISR;  
} RealTimeClock_TDeviceData, *RealTimeClock_TDeviceDataPtr;  
...
LDD_TDeviceData * RealTimeClock_Init(LDD_TUserData *UserDataPtr, bool SoftInit)
{
  ...
  DevDataPtr->UserDataPtr = UserDataPtr;  
   
   
   
  DevDataPtr->SavedISRSettings_RTC_ISR.isrData = _int_get_isr_data(0x24u);
  DevDataPtr->SavedISRSettings_RTC_ISR.isrFunction = _int_install_isr(0x24u, RealTimeClock_Interrupt, DevDataPtr);
   
  (PE_LDD_DeviceDataList[0x08U] = DevDataPtr);
  DevDataPtr->EnUser = ((boolean)1);            
   
   
  ((((SIM_MemMapPtr)0x40047000u))->SCGC6) |= 0x20000000u;
  if (!SoftInit) {
    ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0x00U;                     
    ((((RTC_MemMapPtr)0x4003D000u))->TPR) = (((uint32_t)(((uint32_t)(0x00))<<0))&0xFFFFu);        
    ((((RTC_MemMapPtr)0x4003D000u))->TSR) = (((uint32_t)(((uint32_t)(0x02))<<0))&0xFFFFFFFFu);        
    ((((RTC_MemMapPtr)0x4003D000u))->TAR) = (((uint32_t)(((uint32_t)(0x00))<<0))&0xFFFFFFFFu);        
    ((((RTC_MemMapPtr)0x4003D000u))->TCR) = (((uint32_t)(((uint32_t)(0x00))<<24))&0xFF000000u) |
              (((uint32_t)(((uint32_t)(0x00))<<16))&0xFF0000u) |
              (((uint32_t)(((uint32_t)(0x00))<<8))&0xFF00u) |
              (((uint32_t)(((uint32_t)(0x00))<<0))&0xFFu);        
  ...
  ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (((uint32_t)(((uint32_t)(0x00100000))<<0))&0xFFFFFFFFu);
  return DevDataPtr;
}
...
LDD_TError RealTimeClock_Enable(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  DevDataPtr->EnUser = ((boolean)1);
  ( ((1u) == 0u) ? ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0U) : ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0x10U) );
  return 0x00U;
}
...
LDD_TError RealTimeClock_Disable(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  DevDataPtr->EnUser = ((boolean)0);
  ( ((0u) == 0u) ? ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0U) : ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0x10U) );
  return 0x00U;
}
...
void RealTimeClock_GetTime(LDD_TDeviceData *DeviceDataPtr, LDD_RTC_TTime *TimePtr)
{
  ...
  (void)DeviceDataPtr;                  
  Seconds = ( ((((RTC_MemMapPtr)0x4003D000u))->TSR) );  
  Seconds--;
  Days = Seconds / 86400U;              
  Seconds = Seconds % 86400U;           
  TimePtr->Hour = Seconds / 3600U;      
  Seconds = Seconds % 3600u;            
  TimePtr->Minute = Seconds / 60U;      
  TimePtr->Second = Seconds % 60U;      
  TimePtr->DayOfWeek = (Days + 6U) % 7U;  
  TimePtr->Year = (4U * (Days / ((4U * 365U) + 1U))) + 2000U;  
...
LDD_TError RealTimeClock_SetTime(LDD_TDeviceData *DeviceDataPtr, LDD_RTC_TTime *TimePtr)
{
  ...
  if ((TimePtr->Year < 2000U) || (TimePtr->Year > 2099U) || (TimePtr->Month > 12U) || (TimePtr->Month == 0U) || (TimePtr->Day > 31U) || (TimePtr->Day == 0U)) {  
    return 0x02U;                   
  }
  if (TimePtr->Year & 3U) {             
    if (ULY[TimePtr->Month] < TimePtr->Day) {  
      return 0x02U;                 
    }
  } else {                              
    if (LY[TimePtr->Month] < TimePtr->Day) {  
      return 0x02U;                 
    }
  }
  Seconds = ((TimePtr->Year - 2000U) * 365U) + (((TimePtr->Year - 2000U) + 3U) / 4U);  
  Seconds += MONTH_DAYS[TimePtr->Month];  
  Seconds += TimePtr->Day;              
  if ((TimePtr->Year & 3U) || (TimePtr->Month <= 2U)) {  
    Seconds--;
  }
  Seconds = (Seconds * 86400U) + (TimePtr->Hour * 3600U) + (TimePtr->Minute * 60U) + TimePtr->Second;
  Seconds++;
  ( ((0u) == 0u) ? ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0U) : ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0x10U) );  
  ( ((((RTC_MemMapPtr)0x4003D000u))->TPR) = (uint32_t)(0x00U) );  
  ( ((((RTC_MemMapPtr)0x4003D000u))->TSR) = (uint32_t)(Seconds) );  
  ( ((1u) == 0u) ? ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0U) : ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0x10U) );  
  return 0x00U;
}
...
void RealTimeClock_Interrupt(LDD_RTOS_TISRParameter _isrParameter)
{
  ...
  uint32_t Status = ( ((((RTC_MemMapPtr)0x4003D000u))->SR) );

  if ((Status & 0x1u) != 0x00U) {  
     
    ( ((0u) == 0u) ? ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0U) : ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0x10U) );  
    ( ((((RTC_MemMapPtr)0x4003D000u))->TPR) = (uint32_t)(0x00U) );  
    ( ((((RTC_MemMapPtr)0x4003D000u))->TSR) = (uint32_t)(0x02UL) );  
  } else if ((Status & 0x2u) != 0x00u) {  
     
    ( ((0u) == 0u) ? ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0U) : ( ((((RTC_MemMapPtr)0x4003D000u))->SR) = 0x10U) );  
    ( ((((RTC_MemMapPtr)0x4003D000u))->TPR) = (uint32_t)(0x00U) );  
    ( ((((RTC_MemMapPtr)0x4003D000u))->TSR) = (uint32_t)(0x02UL) );  
  } else {                              
    ( ((((RTC_MemMapPtr)0x4003D000u))->TAR) = (uint32_t)(( ((((RTC_MemMapPtr)0x4003D000u))->TAR) )) );  
