...
static uint8_t mLedStartFlashingPosition = 0x01;
...
void LED_Init( void )
{
    ...
    LED1_Init((( void * )( 0x0UL )));
     
    LED2_Init((( void * )( 0x0UL )));

     
    LED1_SetVal((( void * )( 0x0UL )));
    LED2_SetVal((( void * )( 0x0UL )));
...
void LED_UnInit( void )
{
    ...
    LED1_Deinit((( void * )( 0x0UL )));
     
    LED2_Deinit((( void * )( 0x0UL )));
...
void LED_Operate( LED_t led, LED_OpMode_t operation )
{
    if(led & 0x01)
    {
        ...
        {
        case gLedOn_c:
            LED1_ClrVal((( void * )( 0x0UL )));
            break;
        case gLedOff_c:
            LED1_SetVal((( void * )( 0x0UL )));
            break;
        case gLedToggle_c:
            LED1_NegVal((( void * )( 0x0UL )));
            break;
        }
    }
    if(led & 0x02)
    {
        ...
        {
        case gLedOn_c:
            LED2_ClrVal((( void * )( 0x0UL )));
            break;
        case gLedOff_c:
            LED2_SetVal((( void * )( 0x0UL )));
            break;
        case gLedToggle_c:
            LED2_NegVal((( void * )( 0x0UL )));
            break;
        }
    }
}
...
{
    if (LEDNr & 0x01)
        LED_Operate(0x01, gLedOn_c);  
    if (LEDNr & 0x02)
        LED_Operate(0x02, gLedOn_c);  
}
...
{
    if (LEDNr & 0x01)
        LED_Operate(0x01, gLedOff_c);  
    if (LEDNr & 0x02)
        LED_Operate(0x02, gLedOff_c);  
}
...
{
    if (LEDNr & 0x01)
        LED_Operate(0x01, gLedToggle_c);  
    if (LEDNr & 0x02)
        LED_Operate(0x02, gLedToggle_c);  
}
...
void LED_StartFlash( LED_t LEDNr )
{
    ...
    TMR_StartIntervalTimer(mLEDTimerID, 100, (pfTmrCallBack_t)LED_FlashTimeout, (void*)mLEDTimerID);
}
...
void LED_StartSerialFlash( uint8_t LEDStartPosition )
{
     
    LED_StartFlash(0);

    if(LEDStartPosition >= 0x02)
        LEDStartPosition = 0x01;
    ...
    }while(LEDStartPosition <= (0x02 << 1));

    LED_TurnOnLed(mLedStartFlashingPosition);

    mLedFlashingLEDs = mLedStartFlashingPosition | mLedStartFlashingPosition << 1;  
...
static void LED_ExitSerialFlash( void )
{
    if(mfLedInSerialMode) {
        ...
        }while(mLedStartFlashingPosition <= (0x02 << 1));
        mLedStartFlashingPosition = 0x01;
...
static void LED_FlashTimeout( uint8_t timerId   )
{
    ...
    if(mfLedInSerialMode)
    {
        ...
        if(mLedFlashingLEDs & (0x02 << 1))   
        {
            mLedFlashingLEDs &= 0x03;
