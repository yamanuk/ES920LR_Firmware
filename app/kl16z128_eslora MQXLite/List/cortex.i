...
{
	VCORTEX_NVIC_STRUCT_PTR nvic = (VCORTEX_NVIC_STRUCT_PTR)&(((CORTEX_SCS_STRUCT_PTR)(0xe0000000ul))->NVIC);
    uint_32 ext_irq_no = irq - 16;

	if (irq >= ((0)) && irq <= ((32))) {
		nvic->PRIORITY[ext_irq_no >> 2] = (nvic->PRIORITY[ext_irq_no >> 2] & ~(0xff << ((ext_irq_no & 3) * 8))) | (((prior << (8 - (1))) & ((0xff << (8 - (1))) & 0xff)) << ((ext_irq_no & 3) * 8));
