...
{  
   ...
   a_hw_ticks = (b_hw_ticks & ((0xFFFFFFFFUL) ^ (0x7FFFFFFFL))) | (((uint_32)(r.TICKS[0])) & (0x7FFFFFFFL));
   b_hw_ticks = (((uint_32)(r.TICKS[0])) & ((0xFFFFFFFFUL) ^ (0x7FFFFFFFL))) | (b_hw_ticks & (0x7FFFFFFFL));
   if (o_ptr != ((pointer)0)) *o_ptr = ((boolean)0);

    
   if ((a_hw_ticks >> 31) * (0xFFFFFFFFUL) != b_hw_ticks)
   {
      a_hw_ticks = (0x7FFFFFFFL) + (a_hw_ticks >> 31);
      if (o_ptr != ((pointer)0)) *o_ptr = ((boolean)1);
   }
