...
)
{
    ...
    ((QUEUE_STRUCT_PTR)(&event_ptr->WAITING_TASKS))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&event_ptr->WAITING_TASKS))->NEXT); ((QUEUE_STRUCT_PTR)(&event_ptr->WAITING_TASKS))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&event_ptr->WAITING_TASKS))->NEXT); ((QUEUE_STRUCT_PTR)(&event_ptr->WAITING_TASKS))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&event_ptr->WAITING_TASKS))->MAX = (uint_16)0;
    event_ptr->VALUE = 0;
    ...
    {
        if (kernel_data->LWEVENTS.NEXT == ((pointer)0))
        {
             
            ((QUEUE_STRUCT_PTR)(&kernel_data->LWEVENTS))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->LWEVENTS))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->LWEVENTS))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->LWEVENTS))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->LWEVENTS))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&kernel_data->LWEVENTS))->MAX = (uint_16)0;
        }
    }

    event_ptr->VALID = ((_mqx_uint)(0x6C65766E));
    ...
    {
        { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWEVENTS)))->PREV)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&event_ptr->LINK))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWEVENTS)))->PREV)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&event_ptr->LINK))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&event_ptr->LINK))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWEVENTS)))->PREV)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&event_ptr->LINK))); }; ++((QUEUE_STRUCT_PTR)((&kernel_data->LWEVENTS)))->SIZE;;
    }
...
)
{
    ...
    return _lwevent_create_internal(event_ptr, flags, ((boolean)0));
}
...
)
{
    ...
    _int_disable();
    if (event_ptr->VALID != ((_mqx_uint)(0x6C65766E)))
    {
        _int_enable();
        ;
        return (((0x0000)|0x39));
    ...
    event_ptr->VALID = 0;
    while (((QUEUE_STRUCT_PTR)(&event_ptr->WAITING_TASKS))->SIZE)
    {
        td_ptr = (pointer)((QUEUE_STRUCT_PTR)(&event_ptr->WAITING_TASKS))->NEXT; { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)((&event_ptr->WAITING_TASKS)))->SIZE;;
    ...
    {
        { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(event_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(event_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&kernel_data->LWEVENTS))->SIZE;;
    }
...
)
{
    ...
    return _lwevent_destroy_internal(event_ptr, ((boolean)0));
}
...
)
{
    ...
    if (((QUEUE_STRUCT_PTR)(&event_ptr->WAITING_TASKS))->SIZE)
    {
        ...
        while (q_ptr != (QUEUE_ELEMENT_STRUCT_PTR) ((pointer) &event_ptr->WAITING_TASKS))
        {
            ...
            if (((td_ptr->FLAGS & (0x0080)) && ((td_ptr->LWEVENT_BITS & set_bits)
                            == td_ptr->LWEVENT_BITS)) || ((!(td_ptr->FLAGS & (0x0080)))
                            && (td_ptr->LWEVENT_BITS & set_bits)))
            {
                { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(q_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(q_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&event_ptr->WAITING_TASKS))->SIZE;;
                if ( ((TD_STRUCT_PTR)td_ptr)->STATE & (0x100) ) { { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)(&kernel_data->TIMEOUT_QUEUE))->SIZE;; ((TD_STRUCT_PTR)td_ptr)->STATE &= ~(0x100); ((TD_STRUCT_PTR)td_ptr)->STATE |= (0x02 | (0x001)); };
                td_ptr->INFO = 0;
                ; if ( ((uchar *) (td_ptr)->MY_QUEUE) > (uchar *) (kernel_data->CURRENT_READY_Q) ) { kernel_data->CURRENT_READY_Q = (td_ptr)->MY_QUEUE; } (td_ptr)->STATE = (0x02); (td_ptr)->TD_PREV = ((td_ptr)->MY_QUEUE)->TAIL_READY_Q; (td_ptr)->TD_NEXT = ((td_ptr)->TD_PREV)->TD_NEXT; ((td_ptr)->TD_PREV)->TD_NEXT = (td_ptr); ((td_ptr)->MY_QUEUE)->TAIL_READY_Q = (td_ptr);  ;;
...
(
    pointer *   event_error_ptr,
    pointer *   td_error_ptr
)
{
    KERNEL_DATA_STRUCT_PTR  kernel_data;
    LWEVENT_STRUCT_PTR      event_ptr;
    ...
    *td_error_ptr = ((pointer)0);
    *event_error_ptr = ((pointer)0);
    ...
    queue_size = ((QUEUE_STRUCT_PTR)(&kernel_data->LWEVENTS))->SIZE;
    while (queue_size--)
    {
        if (event_ptr->VALID != ((_mqx_uint)(0x6C65766E)))
        {
...
)
{
    ...
    result = _lwevent_wait_internal(event_ptr, bit_mask, all, tick_ptr, ((boolean)0));
...
)
{
    ...
    { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&event_ptr->WAITING_TASKS)))->PREV)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&event_ptr->WAITING_TASKS)))->PREV)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&event_ptr->WAITING_TASKS)))->PREV)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))); }; ++((QUEUE_STRUCT_PTR)((&event_ptr->WAITING_TASKS)))->SIZE;;

     
    td_ptr->STATE = (0x2C | ((0x400)|(0x001)));
...
)
{
    ...
    result = _lwevent_wait_internal(event_ptr, bit_mask, all, tick_ptr, ((boolean)1));
...
)
{
    ...
    if (timeout_in_ticks)
    {
        ...
        ((PSP_TICK_STRUCT_PTR)(&ticks))->TICKS[0] = ((PSP_TICK_STRUCT_PTR)(&ticks))->TICKS[0] + (uint_64)(timeout_in_ticks);
        result = _lwevent_wait_internal(event_ptr, bit_mask, all, &ticks, ((boolean)0));
    }
    else
    {
        result = _lwevent_wait_internal(event_ptr, bit_mask, all, ((pointer)0), ((boolean)0));
    }  
