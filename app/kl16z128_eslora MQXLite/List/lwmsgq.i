...
)
{
    ...
    ((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_WRITERS))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_WRITERS))->NEXT); ((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_WRITERS))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_WRITERS))->NEXT); ((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_WRITERS))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_WRITERS))->MAX = (uint_16)0;
    ((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_READERS))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_READERS))->NEXT); ((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_READERS))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_READERS))->NEXT); ((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_READERS))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_READERS))->MAX = (uint_16)0;
    ...
    {
        if (kernel_data->LWMSGQS.NEXT == ((pointer)0))
        {
             
            ((QUEUE_STRUCT_PTR)(&kernel_data->LWMSGQS))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->LWMSGQS))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->LWMSGQS))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)&((QUEUE_STRUCT_PTR)(&kernel_data->LWMSGQS))->NEXT); ((QUEUE_STRUCT_PTR)(&kernel_data->LWMSGQS))->SIZE = (uint_16)0; ((QUEUE_STRUCT_PTR)(&kernel_data->LWMSGQS))->MAX = (uint_16)0;
        }
    }

    q_ptr->VALID = (_mqx_uint)(0x6C776D73);
    ...
    {
        { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWMSGQS)))->PREV)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&q_ptr->LINK))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWMSGQS)))->PREV)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&q_ptr->LINK))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&q_ptr->LINK))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&kernel_data->LWMSGQS)))->PREV)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&q_ptr->LINK))); }; ++((QUEUE_STRUCT_PTR)((&kernel_data->LWMSGQS)))->SIZE;;
    }
...
)
{
    ...
    return _lwmsgq_init_internal(location, num_messages, msg_size, ((boolean)0));
}
...
{ 
    ...
    _int_disable();
    if (q_ptr->VALID != (_mqx_uint)(0x6C776D73))
    {
        _int_enable();
        ;
        return (((0x0000) | 0x0700) | 0x80);
    }  
    if ((((LWMSGQ_STRUCT_PTR)(q_ptr))->CURRENT_SIZE == 0))
    {
        if (flags & (0x04))
        {
            td_ptr = kernel_data->ACTIVE_PTR;
            while ((((LWMSGQ_STRUCT_PTR)(q_ptr))->CURRENT_SIZE == 0))
            {
                td_ptr->STATE = (0x30 | (0x001) | (0x400));
                td_ptr->INFO = (_mqx_uint) &q_ptr->WAITING_READERS;
                { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; };
                { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&q_ptr->WAITING_READERS)))->PREV)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&q_ptr->WAITING_READERS)))->PREV)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&q_ptr->WAITING_READERS)))->PREV)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))); }; ++((QUEUE_STRUCT_PTR)((&q_ptr->WAITING_READERS)))->SIZE;;
                if (ticks || (flags & ((0x08) | (0x10))))
                {
                    if (ticks)
                    {
                        ((PSP_TICK_STRUCT_PTR)(&td_ptr->TIMEOUT))->TICKS[0] = ((PSP_TICK_STRUCT_PTR)(&kernel_data->TIME))->TICKS[0] + (uint_64)(ticks);
                    }
                    else if (flags & (0x08))
                    {
                    ...
                    {
                        _psp_add_ticks((PSP_TICK_STRUCT_PTR)(tick_ptr), (PSP_TICK_STRUCT_PTR)(&kernel_data->TIME), (PSP_TICK_STRUCT_PTR)(&td_ptr->TIMEOUT));
                    }  
    ...
    q_ptr->CURRENT_SIZE--;
    if (!(((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_WRITERS))->SIZE == 0))
    {
        td_ptr = (pointer)((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_WRITERS))->NEXT; { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)((&q_ptr->WAITING_WRITERS)))->SIZE;;
        td_ptr = (TD_STRUCT *)((uchar_ptr)td_ptr - (_mqx_uint)&(((TD_STRUCT *)0)->AUX_QUEUE));
        td_ptr->INFO = 0;  
        ; if ( ((uchar *) (td_ptr)->MY_QUEUE) > (uchar *) (kernel_data->CURRENT_READY_Q) ) { kernel_data->CURRENT_READY_Q = (td_ptr)->MY_QUEUE; } (td_ptr)->STATE = (0x02); (td_ptr)->TD_PREV = ((td_ptr)->MY_QUEUE)->TAIL_READY_Q; (td_ptr)->TD_NEXT = ((td_ptr)->TD_PREV)->TD_NEXT; ((td_ptr)->TD_PREV)->TD_NEXT = (td_ptr); ((td_ptr)->MY_QUEUE)->TAIL_READY_Q = (td_ptr);  ;;
...
{ 
    ...
    if ((((LWMSGQ_STRUCT_PTR)(q_ptr))->CURRENT_SIZE >= ((LWMSGQ_STRUCT_PTR)(q_ptr))->MAX_SIZE))
    {
        if (flags & (0x01))
        {
            td_ptr = kernel_data->ACTIVE_PTR;
            while ((((LWMSGQ_STRUCT_PTR)(q_ptr))->CURRENT_SIZE >= ((LWMSGQ_STRUCT_PTR)(q_ptr))->MAX_SIZE))
            {
                td_ptr->STATE = (0x32 | (0x001) | (0x400));
                td_ptr->INFO = (_mqx_uint) &q_ptr->WAITING_WRITERS;
                { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(td_ptr)))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; };
                { QUEUE_ELEMENT_STRUCT_PTR nxt = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&q_ptr->WAITING_WRITERS)))->PREV)))->NEXT; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))))->NEXT = nxt; ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&q_ptr->WAITING_WRITERS)))->PREV)))->NEXT = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))); ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))))->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)(((QUEUE_STRUCT_PTR)((pointer)(&q_ptr->WAITING_WRITERS)))->PREV)); nxt->PREV = (QUEUE_ELEMENT_STRUCT_PTR)((pointer)((&td_ptr->AUX_QUEUE))); }; ++((QUEUE_STRUCT_PTR)((&q_ptr->WAITING_WRITERS)))->SIZE;;
                _sched_execute_scheduler_internal();  
            }  
        }
        else
    ...
    q_ptr->CURRENT_SIZE++;
    if (!(((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_READERS))->SIZE == 0))
    {
        td_ptr = (pointer)((QUEUE_STRUCT_PTR)(&q_ptr->WAITING_READERS))->NEXT; { QUEUE_ELEMENT_STRUCT_PTR prev_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->PREV; QUEUE_ELEMENT_STRUCT_PTR next_ptr = ((QUEUE_ELEMENT_STRUCT_PTR)((pointer)((td_ptr))))->NEXT; prev_ptr->NEXT = next_ptr; next_ptr->PREV = prev_ptr; }; --((QUEUE_STRUCT_PTR)((&q_ptr->WAITING_READERS)))->SIZE;;
        td_ptr = (TD_STRUCT *)((uchar_ptr)td_ptr - (_mqx_uint)&(((TD_STRUCT *)0)->AUX_QUEUE));
