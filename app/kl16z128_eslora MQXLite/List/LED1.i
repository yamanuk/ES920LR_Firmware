...
typedef LED1_TDeviceData *LED1_TDeviceDataPtr ;  
...
LDD_TDeviceData* LED1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  ((((GPIO_MemMapPtr)0x400FF100u))->PDDR) |= (((uint32_t)(((uint32_t)(0x10000))<<0))&0xFFFFFFFFu);
   
   
  ((((GPIO_MemMapPtr)0x400FF100u))->PDOR) |= (((uint32_t)(((uint32_t)(0x10000))<<0))&0xFFFFFFFFu);
   
   
  ((((PORT_MemMapPtr)0x4004D000u))->PCR[16]) = (uint32_t)((((((PORT_MemMapPtr)0x4004D000u))->PCR[16]) & (uint32_t)~(uint32_t)(
                0x1000000u |
  ...
  (PE_LDD_DeviceDataList[0x09U] = DeviceDataPrv);
...
void LED1_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  ((((GPIO_MemMapPtr)0x400FF100u))->PDDR) &= (uint32_t)~(uint32_t)((((uint32_t)(((uint32_t)(0x10000))<<0))&0xFFFFFFFFu));
   
  (PE_LDD_DeviceDataList[0x09U] = ((pointer)0));
...
{
  (void)DeviceDataPtr;                  
  ( ((((FGPIO_MemMapPtr)0xF80FF100u))->PCOR) = (uint32_t)(0x10000U) );
}
...
{
  (void)DeviceDataPtr;                  
  ( ((((FGPIO_MemMapPtr)0xF80FF100u))->PSOR) = (uint32_t)(0x10000U) );
}
...
{
  (void)DeviceDataPtr;                  
  ( ((((FGPIO_MemMapPtr)0xF80FF100u))->PTOR) = (uint32_t)(0x10000U) );
}
