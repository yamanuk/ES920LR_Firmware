...
static const uint8_t MCGTransitionMatrix[4][4] = {
  ...
  {  0x00U,  0x01U,  0x02U,  0x02U},  
  {  0x01U,  0x01U,  0x02U,  0x03U},  
  {  0x02U,  0x02U,  0x02U,  0x03U}   
};

 
volatile uint8_t SR_reg;                
volatile uint8_t SR_lock = 0x00U;       
static uint8_t ClockConfigurationID = 0x00U;  
...
static void Cpu_SetMCGModePEE(uint8_t CLKMode)
{
    ...
    case 1U:
        ...
        ((((OSC_MemMapPtr)0x40065000u))->CR) = 0x80u;

         
        ((((MCG_MemMapPtr)0x40064000u))->C1) = ((((uint8_t)(((uint8_t)(0x00))<<6))&0xC0u) | (((uint8_t)(((uint8_t)(0x05))<<3))&0x38u) | 0x2u);

         
        ((((MCG_MemMapPtr)0x40064000u))->C2) = (uint8_t)((((((MCG_MemMapPtr)0x40064000u))->C2) & (uint8_t)~(uint8_t)(
                 0x80u |
                 (((uint8_t)(((uint8_t)(0x01))<<4))&0x30u)|
                 0x8u   |
                 0x4u |
                 0x2u     |
                 0x1u)) |
                 (uint8_t)((((uint8_t)(((uint8_t)(0x02))<<4))&0x30u)));

         
        ((((MCG_MemMapPtr)0x40064000u))->C5) = (((uint8_t)(((uint8_t)(0x0F))<<0))&0x1Fu);

         
        ((((MCG_MemMapPtr)0x40064000u))->C6) = (0x40u | (((uint8_t)(((uint8_t)(0x00))<<0))&0x1Fu));

         
        while((((((MCG_MemMapPtr)0x40064000u))->S) & 0x0CU) != 0x0CU);
...
static void Cpu_SetMCGModePBE(uint8_t CLKMode)
{
    ...
    case 0U:
        ...
        ((((MCG_MemMapPtr)0x40064000u))->C1) = ((((uint8_t)(((uint8_t)(0x02))<<6))&0xC0u) | (((uint8_t)(((uint8_t)(0x05))<<3))&0x38u) | 0x2u);
        ...
        ((((MCG_MemMapPtr)0x40064000u))->C5) = (((uint8_t)(((uint8_t)(0x09))<<0))&0x1Fu);

         
        ((((MCG_MemMapPtr)0x40064000u))->C6) = (0x40u | (((uint8_t)(((uint8_t)(0x00))<<0))&0x1Fu));

         
        while((((((MCG_MemMapPtr)0x40064000u))->S) & 0x0CU) != 0x08U);

         
        while((((((MCG_MemMapPtr)0x40064000u))->S) & 0x40u) == 0x00U);
...
static void Cpu_SetMCGModeFBE(uint8_t CLKMode)
{
    ...
    case 0U:
        ...
        ((((MCG_MemMapPtr)0x40064000u))->C4) &= (uint8_t)~(uint8_t)((0x80u | (((uint8_t)(((uint8_t)(0x03))<<5))&0x60u)));

         
        ((((MCG_MemMapPtr)0x40064000u))->C5) = (((uint8_t)(((uint8_t)(0x00))<<0))&0x1Fu);

         
        ((((MCG_MemMapPtr)0x40064000u))->C6) = (((uint8_t)(((uint8_t)(0x00))<<0))&0x1Fu);
...
static void Cpu_SetMCGModeFEI(uint8_t CLKMode)
{
    ...
    case 0U:
        ...
        ((((MCG_MemMapPtr)0x40064000u))->C1) = (((uint8_t)(((uint8_t)(0x00))<<6))&0xC0u) |
                 (((uint8_t)(((uint8_t)(0x00))<<3))&0x38u)|
                 0x4u |
                 0x2u;
        ...
        ((((MCG_MemMapPtr)0x40064000u))->C4) &= (uint8_t)~(uint8_t)((0x80u | (((uint8_t)(((uint8_t)(0x03))<<5))&0x60u)));
        ((((MCG_MemMapPtr)0x40064000u))->C4) |= 0x80u;
...
static void Cpu_SetMCG(uint8_t CLKMode)
{
    ...
    NextMCGMode = Cpu_GetCurrentMCGMode();  
    do {
        NextMCGMode = MCGTransitionMatrix[NextMCGMode][TargetMCGMode];  
    ...
    } while (TargetMCGMode != NextMCGMode);  
}
...
{
    switch (((((MCG_MemMapPtr)0x40064000u))->C1)  & 0xC0u) {
    case  0x00U:
         
        if ((((((MCG_MemMapPtr)0x40064000u))->C6) & 0x40u) == 0x00U) {
...
LDD_TError Cpu_SetClockConfiguration(LDD_TClockConfiguration ModeID)
{
    ...
    case 0x00U:
        ...
        ((((SIM_MemMapPtr)0x40047000u))->CLKDIV1) = ((((uint32_t)(((uint32_t)(0x01))<<28))&0xF0000000u) | (((uint32_t)(((uint32_t)(0x03))<<16))&0x70000u));  
        Cpu_SetMCG(0U);                   

         
        ((((SIM_MemMapPtr)0x40047000u))->CLKDIV1) = ((((uint32_t)(((uint32_t)(0x00))<<28))&0xF0000000u) | (((uint32_t)(((uint32_t)(0x00))<<16))&0x70000u));  

         
        ((((SIM_MemMapPtr)0x40047000u))->SOPT2) &= (uint32_t)~(uint32_t)(0x10000u);  
        ...
        ((((SIM_MemMapPtr)0x40047000u))->SOPT2) = (uint32_t)((((((SIM_MemMapPtr)0x40047000u))->SOPT2) & (uint32_t)~(uint32_t)(
                    (((uint32_t)(((uint32_t)(0x02))<<24))&0x3000000u))) |
                    (uint32_t)(
                    (((uint32_t)(((uint32_t)(0x01))<<24))&0x3000000u)
                    ));                   
        break;
    ...
    case 0x01U:
        ...
        ((((SIM_MemMapPtr)0x40047000u))->CLKDIV1) = ((((uint32_t)(((uint32_t)(0x00))<<28))&0xF0000000u) | (((uint32_t)(((uint32_t)(0x01))<<16))&0x70000u));  
    ...
    LDD_SetClockConfiguration(ModeID);    
    ClockConfigurationID = ModeID;        
    return 0x00U;
}
 ...
 
{
    ...
    ((((SIM_MemMapPtr)0x40047000u))->COPC) = (((uint32_t)(((uint32_t)(0x03))<<2))&0xCu);

     
    ((((SIM_MemMapPtr)0x40047000u))->CLKDIV1) = ((((uint32_t)(((uint32_t)(0x00))<<28))&0xF0000000u) | (((uint32_t)(((uint32_t)(0x03))<<16))&0x70000u));  

     
    ((((SIM_MemMapPtr)0x40047000u))->SCGC5) |= 0x2000u |
                 0x1000u |
                 0x800u |
                 0x400u |
                 0x200u;    

    if ((((((PMC_MemMapPtr)0x4007D000u))->REGSC) & 0x8u) != 0x0U) {
    ...
    ((((SIM_MemMapPtr)0x40047000u))->SOPT2) = (uint32_t)((((((SIM_MemMapPtr)0x40047000u))->SOPT2) & (uint32_t)~(uint32_t)((((uint32_t)(((uint32_t)(0x02))<<24))&0x3000000u))) |
                           (uint32_t)((((uint32_t)(((uint32_t)(0x01))<<24))&0x3000000u)));    
    ...
    ((((PORT_MemMapPtr)0x4004B000u))->PCR[1]) = (((uint32_t)(((uint32_t)(1))<<8))&0x700u) | 0x2u | 0x1u;  
...
void PE_low_level_init(void)
{
    ...
    if ((0) != _mqxlite_init(&MQX_init_struct)) while(1);                 

     

     
     
    ((((RCM_MemMapPtr)0x4007F000u))->RPFW) &= (uint8_t)~(uint8_t)((((uint8_t)(((uint8_t)(0x1F))<<0))&0x1Fu));

     
    ((((RCM_MemMapPtr)0x4007F000u))->RPFC) &= (uint8_t)~(uint8_t)(0x4u | (((uint8_t)(((uint8_t)(0x03))<<0))&0x3u));

     

     
     
    ((((PMC_MemMapPtr)0x4007D000u))->LVDSC1) = (uint8_t)((((((PMC_MemMapPtr)0x4007D000u))->LVDSC1) & (uint8_t)~(uint8_t)(0x20u |
                 (((uint8_t)(((uint8_t)(0x03))<<0))&0x3u))) | (uint8_t)(0x40u |
                 0x10u));

     
    ((((PMC_MemMapPtr)0x4007D000u))->LVDSC2) = (uint8_t)((((((PMC_MemMapPtr)0x4007D000u))->LVDSC2) & (uint8_t)~(uint8_t)(0x20u |
                 (((uint8_t)(((uint8_t)(0x03))<<0))&0x3u))) | (uint8_t)(0x40u));

     
    ((((PMC_MemMapPtr)0x4007D000u))->REGSC) &= (uint8_t)~(uint8_t)(0x10u |
                 0x8u | 0x1u);

     
     
    ((((SMC_MemMapPtr)0x4007E000u))->PMPROT) = 0x2u | 0x8u | 0x20u;

     
     
    ((((PORT_MemMapPtr)0x40049000u))->PCR[20]) = (uint32_t)((((((PORT_MemMapPtr)0x40049000u))->PCR[20]) & (uint32_t)~(uint32_t)(0x1000000u)) |
                  (uint32_t)((((uint32_t)(((uint32_t)(0x07))<<8))&0x700u)));

     
    ((((NVIC_MemMapPtr)0xE000E100u))->IP[1]) &= (uint32_t)~(uint32_t)((((uint32_t)(((uint32_t)(0xFF))<<16))&0xFF0000u));
    ResetSource = (uint16_t)(((uint16_t)((((RCM_MemMapPtr)0x4007F000u))->SRS1)) << 8U);
    ResetSource |= ((((RCM_MemMapPtr)0x4007F000u))->SRS0);
    Cpu_OnReset(ResetSource);             

     
    (void)UARTA_Init(((pointer)0));
}
