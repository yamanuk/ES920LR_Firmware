...
void llwu_configure( unsigned int pin_en, unsigned char rise_fall, unsigned char module_en )
{
    ...
    osInstallIsr(INT_LLW, LLW_IRQHandler, (( void * )( 0x0UL )));

    ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= 1 << ((INT_LLW-16)%32);
    ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= 1 << ((INT_LLW-16)%32);

    temp = ((((LLWU_MemMapPtr)0x4007C000u))->PE1);
    if( pin_en & 0x0001 )
    {
        ;
    }
    ...
    ((((LLWU_MemMapPtr)0x4007C000u))->PE1) = temp;

    temp = ((((LLWU_MemMapPtr)0x4007C000u))->PE2);
    if( pin_en & 0x0010 )
    {
        ;
    }
    if( pin_en & 0x0020 )
    {
        temp |= (((uint8_t)(((uint8_t)(rise_fall))<<2))&0xCu);
        ((((LLWU_MemMapPtr)0x4007C000u))->F1) |= 0x20u;   
    }
    if( pin_en & 0x0040 )
    {
        temp |= (((uint8_t)(((uint8_t)(rise_fall))<<4))&0x30u);
        ((((LLWU_MemMapPtr)0x4007C000u))->F1) |= 0x40u;   
    }
    if( pin_en & 0x0080 )
    {
        temp |= (((uint8_t)(((uint8_t)(rise_fall))<<6))&0xC0u);
        ((((LLWU_MemMapPtr)0x4007C000u))->F1) |= 0x80u;   
    }
    ((((LLWU_MemMapPtr)0x4007C000u))->PE2) = temp;

    temp = ((((LLWU_MemMapPtr)0x4007C000u))->PE3);
    if( pin_en & 0x0100 )
    {
        temp |= (((uint8_t)(((uint8_t)(rise_fall))<<0))&0x3u);
    ...
    {
        temp |= (((uint8_t)(((uint8_t)(rise_fall))<<6))&0xC0u);
        ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x8u;   
    }
    ((((LLWU_MemMapPtr)0x4007C000u))->PE3) = temp;

    temp = ((((LLWU_MemMapPtr)0x4007C000u))->PE4);
    if( pin_en & 0x1000 )
    {
        temp |= (((uint8_t)(((uint8_t)(rise_fall))<<0))&0x3u);
        ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x10u;   
    }
    if( pin_en & 0x2000 )
    {
        temp |= (((uint8_t)(((uint8_t)(rise_fall))<<2))&0xCu);
        ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x20u;   
    }
    if( pin_en & 0x4000 )
    {
        temp |= (((uint8_t)(((uint8_t)(rise_fall))<<4))&0x30u);
        ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x40u;   
    }
    if( pin_en & 0x8000 )
    {
        temp |= (((uint8_t)(((uint8_t)(rise_fall))<<6))&0xC0u);
        ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x80u;   
    }
    ((((LLWU_MemMapPtr)0x4007C000u))->PE4) = temp;

    if( module_en == 0 )
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->ME) = 0;
    }
    else
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->ME) |= module_en;  
    }
}
...
void llwu_configure_filter( unsigned int wu_pin_num, unsigned char filter_en, unsigned char rise_fall )
{
    ...
    ((((LLWU_MemMapPtr)0x4007C000u))->FILT1) = 0x80u;
    ((((LLWU_MemMapPtr)0x4007C000u))->FILT2) = 0x80u;

    if(filter_en == 1)
    {
         
        temp |= (0x80u) | ((((uint8_t)(((uint8_t)(rise_fall))<<5))&0x60u) | (((uint8_t)(((uint8_t)(wu_pin_num))<<0))&0xFu));
        ((((LLWU_MemMapPtr)0x4007C000u))->FILT1) = temp;
    }
    else if (filter_en == 2)
    {
         
        temp |= (0x80u) | ((((uint8_t)(((uint8_t)(rise_fall))<<5))&0x60u) | (((uint8_t)(((uint8_t)(wu_pin_num))<<0))&0xFu));
        ((((LLWU_MemMapPtr)0x4007C000u))->FILT2) = temp;
    }
    else
    {
        ;
...
void LLW_IRQHandler( void *param )
{
    if (((((LLWU_MemMapPtr)0x4007C000u))->F1) & 0x20u)
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->F1) |= 0x20u;   
    }
    if (((((LLWU_MemMapPtr)0x4007C000u))->F1) & 0x40u)
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->F1) |= 0x40u;   
    }
    if (((((LLWU_MemMapPtr)0x4007C000u))->F1) & 0x80u)
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->F1) |= 0x80u;   
    }
    ...
    if (((((LLWU_MemMapPtr)0x4007C000u))->F2) & 0x8u)
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x8u;   
    }
    if (((((LLWU_MemMapPtr)0x4007C000u))->F2) & 0x10u)
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x10u;   
    }
    if (((((LLWU_MemMapPtr)0x4007C000u))->F2) & 0x20u)
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x20u;   
    }
    if (((((LLWU_MemMapPtr)0x4007C000u))->F2) & 0x40u)
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x40u;   
    }
    if (((((LLWU_MemMapPtr)0x4007C000u))->F2) & 0x80u)
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x80u;   
    }
    ...
    if(((((LLWU_MemMapPtr)0x4007C000u))->FILT1) & 0x80u)
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->FILT1) |= 0x80u;
    }
    if(((((LLWU_MemMapPtr)0x4007C000u))->FILT2) & 0x80u)
    {
        ((((LLWU_MemMapPtr)0x4007C000u))->FILT2) |= 0x80u;
    }
    ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= 1 << ((INT_LLW-16)%32);
