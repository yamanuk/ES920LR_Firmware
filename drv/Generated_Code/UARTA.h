...
#define UARTA_BM_1200BAUD         0u   /* Baud rate constant for switch to the baud rate mode 0 */
#define UARTA_BM_2400BAUD         1u   /* Baud rate constant for switch to the baud rate mode 1 */
#define UARTA_BM_4800BAUD         2u   /* Baud rate constant for switch to the baud rate mode 2 */
#define UARTA_BM_9600BAUD         3u   /* Baud rate constant for switch to the baud rate mode 3 */
#define UARTA_BM_19200BAUD        4u   /* Baud rate constant for switch to the baud rate mode 4 */
#define UARTA_BM_38400BAUD        5u   /* Baud rate constant for switch to the baud rate mode 5 */
#define UARTA_BM_57600BAUD        6u   /* Baud rate constant for switch to the baud rate mode 6 */
#define UARTA_BM_115200BAUD       7u   /* Baud rate constant for switch to the baud rate mode 7 */
#define UARTA_BM_230400BAUD       8u   /* Baud rate constant for switch to the baud rate mode 8 */
...
#define UARTA_PRPH_BASE_ADDRESS  0x4006A000U

/*! Device data structure pointer used when auto initialization property is enabled. This constant can be passed as a first parameter to all component's methods. */
#define UARTA_DeviceData  ((LDD_TDeviceData *)PE_LDD_GetDeviceStructure(PE_LDD_COMPONENT_UARTA_ID))

/* Methods configuration constants - generated for all enabled component's methods */
#define UARTA_Init_METHOD_ENABLED      /*!< Init method of the component UARTA is enabled (generated) */
#define UARTA_SendBlock_METHOD_ENABLED /*!< SendBlock method of the component UARTA is enabled (generated) */
#define UARTA_ReceiveBlock_METHOD_ENABLED /*!< ReceiveBlock method of the component UARTA is enabled (generated) */
#define UARTA_SelectBaudRate_METHOD_ENABLED /*!< SelectBaudRate method of the component UARTA is enabled (generated) */

/* Events configuration constants - generated for all enabled component's events */
#define UARTA_OnBlockReceived_EVENT_ENABLED /*!< OnBlockReceived event of the component UARTA is enabled (generated) */
#define UARTA_OnBlockSent_EVENT_ENABLED /*!< OnBlockSent event of the component UARTA is enabled (generated) */
...
typedef UARTA_TDeviceData *UARTA_TDeviceDataPtr ; /*!< Pointer to the device data structure. */
