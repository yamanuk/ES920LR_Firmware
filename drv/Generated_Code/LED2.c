...
} LED2_TDeviceData;                    /* Device data structure type */

typedef LED2_TDeviceData *LED2_TDeviceDataPtr ; /* Pointer to the device data structure. */
...
LDD_TDeviceData* LED2_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* GPIOE_PDDR: PDD|=0x20000 */
  GPIOE_PDDR |= GPIO_PDDR_PDD(0x20000);
  /* Set initialization value */
  /* GPIOE_PDOR: PDO|=0x20000 */
  GPIOE_PDOR |= GPIO_PDOR_PDO(0x20000);
  ...
  PE_LDD_RegisterDeviceStructure(PE_LDD_COMPONENT_LED2_ID,DeviceDataPrv);
...
void LED2_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  /* GPIOE_PDDR: PDD&=~0x20000 */
  GPIOE_PDDR &= (uint32_t)~(uint32_t)(GPIO_PDDR_PDD(0x20000));
  /* Unregistration of the device structure */
  PE_LDD_UnregisterDeviceStructure(PE_LDD_COMPONENT_LED2_ID);
...
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  GPIO_PDD_ClearPortDataOutputMask(LED2_MODULE_BASE_ADDRESS, LED2_PORT_MASK);
}
...
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  GPIO_PDD_SetPortDataOutputMask(LED2_MODULE_BASE_ADDRESS, LED2_PORT_MASK);
}
...
{
  (void)DeviceDataPtr;                 /* Parameter is not used, suppress unused argument warning */
  GPIO_PDD_TogglePortDataOutputMask(LED2_MODULE_BASE_ADDRESS, LED2_PORT_MASK);
}
