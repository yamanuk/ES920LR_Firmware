...
#define PEcfg_KW01_KL26_30MHz_MQXLite_FLASH 1U
...
#define CPU_BUS_CLK_HZ_CLOCK_CONFIG1    24000000U /* Value of the bus clock frequency in the clock configuration 1 in Hz. */
#define CPU_CORE_CLK_HZ_CLOCK_CONFIG1   48000000U /* Value of the core/system clock frequency in the clock configuration 1 in Hz. */
...
#define CPU_DERIVATIVE_MKL26Z256LL4    /* Name of the selected cpu derivative */
#define CPU_PARTNUM_MKL26Z128VLL4      /* Part number of the selected cpu */
...
#define CPU_OSCER_CLK_HZ_CONFIG_0       30000000UL /* System OSC external reference clock frequency in clock configuration 0 */
...
#define CPU_CORE_CLK_HZ_CONFIG_1        48000000UL /* Core clock frequency in clock configuration 1 */
#define CPU_BUS_CLK_HZ_CONFIG_1         24000000UL /* Bus clock frequency in clock configuration 1 */
...
#define CPU_PLL_FLL_CLK_HZ_CONFIG_1     24000000UL /* PLL/FLL clock frequency in clock configuration 1 */
#define CPU_MCGIR_CLK_HZ_CONFIG_1       32768UL /* MCG internal reference clock frequency in clock configuration 1 */
#define CPU_OSCER_CLK_HZ_CONFIG_1       30000000UL /* System OSC external reference clock frequency in clock configuration 1 */
#define CPU_ERCLK32K_CLK_HZ_CONFIG_1    32768UL /* External reference clock 32k frequency in clock configuration 1 */
#define CPU_MCGFF_CLK_HZ_CONFIG_1       29297UL /* MCG fixed frequency clock */
...
/*
** ===================================================================
**     Method      :  __low_level_init (component MKL26Z256LL4)
**
**     Description :
